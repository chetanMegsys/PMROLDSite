...
|
*/
$config['base_url'] = 'http://localhost/PMRweb/';
...
if(stripos($_SERVER["REQUEST_URI"],'/checkout/paypal/') === FALSE && stripos($_SERVER["REQUEST_URI"],'/checkout/razorpay/') === FALSE && stripos($_SERVER["REQUEST_URI"],'/checkout/stripe/') === FALSE )
{ 
   $config['csrf_protection'] = TRUE;
}
else
