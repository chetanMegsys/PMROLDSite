                ...
                <tbody>
                    <tr>
                        <td colspan="2" style="padding: 0 20px;text-align:center;">
                            <div style="color: #282C7D;border: 1px solid #282C7D;padding: 2px 7px;text-align: center;width: 150px;margin:0 auto 15px;display:inline-block;">
                                <p style="margin: 0px;font-size: 18px;padding:0px;">PERS<span style="color:red">i</span>STENCE</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px;border:1px solid #ddd;"><span>'.$email_setting['user_country'].'</span></td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 10px;border:1px solid #ddd;"><span style="font-weight: bold;">Country as per user IP:</span></td>
                        <td style="padding: 10px;border:1px solid #ddd;"><span>'.$email_setting['country'].'</span></td>
                    </tr>
                    <tr>
                        <td style="padding: 10px;border:1px solid #ddd;"><span style="font-weight: bold;">IP as per user location:</span></td>
                        <td style="padding: 10px;border:1px solid #ddd;"><span>'.$email_setting['ip'].'</span></td>
                    </tr>
                    <tr style="background: #F0F2FF">
                    ...
                    <tr>
                        <td style="padding: 10px;border:1px solid #ddd;"><span style="font-weight: bold;">Report URL:</span></td>
                        <td style="padding: 10px;border:1px solid #ddd;"><span>'.$email_setting['report_slug'].'</span></td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
