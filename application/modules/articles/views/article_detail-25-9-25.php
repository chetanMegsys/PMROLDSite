...
<head>
    ...
    <main role="main">
        ...
        <section class="pressRelDetailsBanner py-3">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                   <div class="col-md-8 col-sm-12">
                    ...
                    <div class="col-md-4 col-sm-12 prrightSide">
                        ...
                        <div class="text-center p-3 py-4 mb-3 bg-white">
                            <p class="font18 text-blue-new text-center bold600"><?php echo ucwords(str_replace("-"," ",$get_articles->rep_url)); ?></p>
                            <p class="mt-3 mb-4 ">
                                <?php echo $get_articles->rep_name; ?>
                            </p>
                            <a href="<?php echo WEBSITE_URL."market-research/".$get_articles->rep_url.".asp"; ?>" class="btn btnOutline mt-2" title="View Reports" style="background-color: #282C7D;">
                                View Report
                            </a>
                        </div>
                        <?php } ?>
