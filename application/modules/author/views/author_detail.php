...
<head>
    ...
    <?php $keyword = ucwords(str_replace("-"," ",$get_authors->url)); ?>
    ...
    <script type="application/ld+json">
        {
            ...
            "headline": "<?php echo $get_authors->name; ?>",
            "image": [
                "<?php echo $image_url; ?>"
            ],
            "datePublished": "<?php echo date('M d, Y',$get_authors->creation); ?>",
            "dateModified": "<?php echo date('M d, Y',$get_authors->creation); ?>",
            "author": {
                "@type": "Person",
                "name": "Team PMR"
            },
            ...
            "description": "<?php echo substr(strip_tags($get_authors->full_desc),0,160); ?>"
        }
    </script>
