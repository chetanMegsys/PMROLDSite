            ...
            <div class="container">
                <div class="row">
                    <!-- <div class="col-md-12 col-sm-12">
                        <p class="secHeading text-center mb-0">Recent Blog</p>
                        <p class="text-center mb-5">The following is a compilation of Blog published by Persistence Market Research.</p>
                    </div> -->
                    ...
                    <div class="col-md-12 col-sm-12">
                    	...
                    	if(!empty($author)){
	                        ...
	                        <div class="mb-5 prListBox bg-white">
	                            ...
	                            <p>
	                                <?php $mr_desc = explode("\n",$author[$i]['short_desc']); echo $mr_desc[0]; ?>
	                            </p>
