...
<body>
    ...
    <main>
                ...
                <div class="row">
                    <div class="col-12 orderDetailsColMob1">
                        <div class="orderDetailsDivMob1 mb-2">
                            ...
                            <p class="mt-0 mb-2 txt-grey2 fs-10 pl-2">Format*: <em>PPT, PDF, EXCEL</em></p>
                            <?php
                                            $license = '';
                                            $license_price = 0;
                                            switch($licenseType){
                            ...
                            <div class="licenseDetails licenseDetailsMob">
                                ...
                                <p class="p2 fs-13 txt-grey2 m-0 py-3 d-flex justify-content-between pl-2">
                                ...
                                <div class="pmr-discount promo_frm_apply  ">
                                    <p class="fs-13 txt-grey2 m-0 py-3 d-flex justify-content-between pl-2">
                                        <span class="">Discount:</span>
                                        <span class="pr-5 spnDiscount">- $<?php echo $discount_price; ?></span>
                                    </p>
                                    <p class="couponText my-2 py-2 bg-white radius4 fs-14 pl-2">
                                ...
                                <?php } ?>                                         
                                <p class="pTotal fs-14 txt-grey2 m-0 py-3 d-flex justify-content-between pl-2">
                                    <span class="">Total <span class="fs-11">(Inclusive of all taxes) :</span></span>
                                    <span class="pr-5 txt-blue spnTotal">$<?php echo ($license_price-$discount_price); ?></span>
                                </p>
                            </div>
                            
                        </div>
                    </div>
                    <div class="col-12 registerBorder">
                        <div class="row">
                            <div class="col-12 reportName">
                                
                                <div class="checkoutForm mt-3">
                                
                                <div class="formBox">
                                    <p class="fs-18 mb-3 mt-0">Please register your details.</p>
                                    <div class="requestform">
                                        <form action="" method="post" name=""  onsubmit="return validateForm();">
                                            ...
                                            <input type="hidden" id="country_name" name="cust_country" value="<?php echo $country_name; ?>">
                                            ...
                                            <input type="hidden" name="paymentType" class="hdnPaymentType" value="PayPal">
                                              <input type="hidden" id="cust_country_code"  name="cust_country_code"  value="<?php echo $cust_country_code; ?>">

                                            <input type="hidden" name="promoid" value="<?php echo $promo_id; ?>">
                                            <input type="hidden" name="license_type" value="<?php echo $selected_license_type; ?>">
                                            <input type="hidden" name="hdnPromoCode" value="<?php echo $hdnPromoCode; ?>">

                                            <div class="row">
                                                <div class="col-xs-12 col-md-12">
                                                    <div class="form-field">
                                                        <input type="email" name="cust_email" id="idPMREmailId" class="form-control emailId" required="required" placeholder="Business Email*">
                                                ...
                                                <div class="col-xs-12 col-md-12">
                                                    <div class="form-field">
                                                        <input type="text" name="cust_name" id="idPMRfullname" class="form-control fullname" required="required" placeholder="Full Name*">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12">
                                                    <div class="form-field">
                                                        ...
                                                        <input type="text" name="cust_phone" id="idPMRContactNo" class="form-control phoneNo" required="required" placeholder="Phone No.*">
                                                ...
                                                <div class="col-md-12 col-xs-12">
                                                    <div class="form-field">
                                                        <textarea name="cust_addr" id="idAddress" cols="30" rows="2" placeholder="Address*" class="form-control company_address" required></textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12">
                                                    <div class="form-field">
                                                        ...
                                                        <input type="text" name="captcha" class="captcha-input form-control captcha txtCaptcha" id="captcha-form" maxlength="3" size="3" tabindex=3 required placeholder="Security Code*"/>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12 col-xs-12">
                                                    <div class="form-field form-control mt-2 mb-4">
                                                ...
                                                <div class="col-md-12 col-xs-12 mt-2 text-center procRegisterBtn">
                                                    <button type="submit" name="btnCheckout" class="btn btnBuyNow" title="Proceed To Register"  value="btnCheckout" >
                                                        Proceed To Checkout
                                                    </button>
                                                </div>    
                                            </div>
        ...
        <section class="py-0 orderDetailsColMob1 mt-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="quickContact right-boxes my-3 ml-5">
                            <p class="fs-13 txt-black contactList bold500 m-0 text-left">Quick Contact</p>
                        ...
                        <div class="footerList text-center mb-3">
