            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 registerBorder">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 py-4 px-5 reportName">
                                ...
                                <!-- <div class="paymentOptBox mb-4">
                                    ...
                                    <div class="paymentRadio">
                                        <input type="radio"  name="radioPay" id="radioRazorpay" class="paymentType" value="Razorpay">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-12">
                                                    <div class="form-field">
                                                      ...
                                                      <!--   <label for="captcha-form" class="form-label"></label> -->
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                                <div class="orderDetailsDiv p-0 mt-4">
                                    ...
                                    <!-- <div class="promo_frm ">
                                        ...
                                        <input type="text" name="PromoCode" class="form-control d-inline-block mr-2 align-top txtPromo" required="required" value="">
