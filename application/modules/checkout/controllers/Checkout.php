...
class Checkout extends MY_Controller{
        ...
        {      // echo "<pre>";
                ...
                elseif(isset($_POST['btnCheckout']) && $_POST['btnCheckout'] != '' && !$this->is_bot($_SERVER['HTTP_USER_AGENT']) )
                {
                        ...
                        $_POST['license_type'] = $_POST['radLicense'];
                        $data['selected_license_type'] = $_POST['radLicense'];
                        unset($_POST['radLicense']);
                        $data['postdata'] = $_POST;     

                        $data['promo_id'] = '';
                        if(!empty($_POST['hdnPromoCode'])) {
                                $selectPromoData = $this->checkout_model->getPromoCode($_POST['hdnPromoCode'],$data['selected_license_type']);
                                ...
                                $chk_data['promo_id'] = $data['promo_id'];
                        }
                        //var_dump($selectPromoData);exit();
                        ...
                        if( !empty($this->data_filter_post($_POST["fcname"])) ){
                                redirect(WEBSITE_URL);
                        }
                                /*** blocker code ***/
                        ...
                        $chk_data['base_amount'] =  $base_amount  = $Data_base_amount[0]['rep_price'];
                         ...
                         $selectPromoData = $this->checkout_model->getPromoById($data['promo_id'],$_POST['license_type']);
