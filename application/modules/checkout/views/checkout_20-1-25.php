...
$hdnPromoCode = isset($_GET['promo'])? $_GET['promo'] : '';
                    ...
                    <div class="col-md-3 col-sm-2">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="<?php echo WEBSITE_URL; ?>" title="Persistence Market Research">
                                <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>themes/image/pmr-logo.webp" alt="Persistence Market Research" title="Persistence Market Research" />
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div class="formBox">
                                            ...
                                            <div class="requestform">
                                                <form action="" method="post" name="" onsubmit="return validateForm();">
                                                    ...
                                                    <input type="hidden" id="hdnPromoCode" name="hdnPromoCode" value="<?php echo $hdnPromoCode; ?>">
