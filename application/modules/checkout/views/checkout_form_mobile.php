                        ...
                        <div class="orderDetailsDivMob1 mb-2">
                            ...
                            <?php
                             ...
                             <div class="licenseDetails">
                                        ...
                                        <input type="text" name="PromoCode" class="form-control d-inline-block mr-2 align-top txtPromo" required="required" value="<?php echo isset($_GET['promo']) && $_GET['promo']!='' ? $_GET['promo'] : ''; ?>" onchange="onChangePromocode(this)">
