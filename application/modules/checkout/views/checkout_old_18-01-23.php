...
<body>
                        ...
                        <div class="row">
                            <!-- <div class="col-md-7 col-sm-6 col-12 reportName">
                                ...
                                <div class="borderBox p-4 highLightBox">
                                    ...
                                    <p><?php echo $report_data[0]['rep_keyword']; ?></p>
                                </div>
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-12">
                                <div class="pmrCheckoutForm px-5 mx-5">
                                <form action="" method="POST" class="px-5">
                                    ...
                                    <p class="fs-18 bold500 px-4 mb-4 pt-4">Select License Type</p>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-12 p-0">
                                                <label class="contRedio contRedioCheckout py-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Single User License">
                                                    <span class="row">
                                                        ...
                                                        <!-- <label class="contRedio contRedioCheckout" data-toggle="tooltip" data-placement="top" title="" data-original-title="Single User License"> -->
                                                            Single User License
                                        ...
                                        <div class="row bgLicenseType bgLicenseType2 border-T-B-none">
                                            <div class="col-lg-12 col-md-12 col-12 p-0">
                                                <label class="contRedio contRedioCheckout py-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Multi User License">
                                                    <span class="row">
                                                        <div class="col-md-8 col-sm-8 col-8">
                                                            <!-- <label class="contRedio contRedioCheckout" data-toggle="tooltip" data-placement="top" title="" data-original-title="Multi User License"> -->
                                                                Multi User License
                                                        ...
                                                        <div class="col-md-4 col-sm-4 col-4">
                                                            $<?php echo $report_data[0]['rep_price_el']; ?>
                                                        </div>
                                                    </span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="row bgLicenseType bgLicenseType3">
                                            <div class="col-lg-12 col-md-12 col-12 p-0">
                                                <label class="contRedio contRedioCheckout py-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Corporate License">
                                                    <span class="row">
                                                        <div class="col-md-8 col-sm-8 col-8">
                                                            <!-- <label class="contRedio contRedioCheckout" data-toggle="tooltip" data-placement="top" title="" data-original-title="Corporate License"> -->
                                                                Corporate License
                                                                <input type="radio" name="radLicense" class="payment_type" value="C" data-name="Corporate license" data-val="<?php echo $report_data[0]['rep_price_cul']; ?>" >
                                                                <span class="checkmark"></span>
                                                            <!-- </label> -->
                                                        </div>
                                                        <div class="col-md-4 col-sm-4 col-4">
                                                            $<?php echo $report_data[0]['rep_price_cul']; ?>
                                                        </div>
                                                    </span>
                                                </label>    
                                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-12">
                                <div class="orderDetailsDiv p-0 mt-4">
                                    <p class="fs-16 txt-black2 mb-1 orderP">Order Summary</p>
                                    <div class="details d-flex">
                                        <!-- <div class="detail-img">
                                            <img src="" alt="Printed Tapes Market" class="img-fluid" title="Printed Tapes Market" width="56" height="79">
                                        </div> -->
                                        <div class="detailText">
                                            ...
                                            <div class="rDeatils d-flex mt-0">
                                                ...
                                                <?php if(isset($report_data[0]['cat_name']) && $report_data[0]['cat_name'] != '' ) {
                                                    ?>
                                    ...
                                    <p class="mb-1 txt-grey2 fs-10">Format*: <em>PPT, PDF, WORD, EXCEL</em></p>
                                    <div class="licenseDetails">
                                        <!-- <p class="fs-14 txt-black3 my-2">Selected License</p> -->
                                        <p class="p2 fs-13 txt-grey2 m-0 py-2 d-flex justify-content-between">
                                        ...
                                        <div class="pmr-discount promo_frm_apply d-none ">
                                            <p class="fs-13 txt-grey2 m-0 py-2 d-flex justify-content-between">
                                                <span class="">Discount:</span>
                                                <span class="pr-5 spnDiscount">- $0</span>
                                            </p>
                                            <p class="couponText mb-2 py-1 px-3 bg-white radius4 fs-14 ">
                                        ...
                                        <p class="p3 fs-14 txt-grey2 m-0 py-2 d-flex justify-content-between">
                                            <span class="bold500">Total <span class="fs-11 bold400">(Inclusive of all taxes) :</span></span>
                                            <span class="pr-5 txt-blue spnTotal bold500">$<?php echo $report_data[0]['rep_price_sul']; ?></span>
                                        </p>
                                    </div>
                                     
                                         <div class="promo_frm <?php echo isset($_GET['custom']) && $_GET['custom']!='' ? 'd-none' : ''; ?>">
                                        <h6 class="txt-black3 fs-14 mt-3 mb-2">Apply Promo Code</h6>
                                        <input type="text" name="PromoCode" class="form-control d-inline-block mr-2 align-top txtPromo" required="required" value="<?php echo isset($_GET['promo']) && $_GET['promo']!='' ? $_GET['promo'] : ''; ?>">
                                    ...
                                    <div class="quickContact right-boxes">
                                        ...
                                        <div class="QuickContactList">
                                            <div class="whatsapp qContactList text-left pr-2 pl-1">
                                                <a href="https://api.whatsapp.com/send?phone=919545518105" class="text-black3 fs-12 d-flex"><span class="quickContactIMG"></span> <span class="quickContactText">Chat on Whatsapp</span></a>
                                            </div>
    ...
    <!-- Exit popup start -->
    <?php $this->load->view("web_exit_popup"); ?> 
