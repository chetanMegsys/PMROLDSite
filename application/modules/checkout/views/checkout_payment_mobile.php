                        ...
                        <div class="orderDetailsDivMob1 mb-2">
                            ...
                            <div class="details d-flex">
                             ...
                             <?php
                                    ...
                                    ?>
                            <p class="my-2 txt-grey2 fs-10 pl-2">Format*: <em>PPT, PDF, EXCEL</em></p>
                    ...
                    <div class="col-12 registerBorder">
                        <div class="row">
                            <div class="col-12 reportName">
                                ...
                                <div class="mt-3">
                                    <p class="fs-18 mb-3 mt-0">Choose Paymnet Mode:</p>
                                    ...
                                    <div class="paymentRadio paymentRadioMob">
                                        <input type="radio" checked="checked" name="payment_type" id="radioPayPal" class="paymentType" value="PayPal">
                                        <label class="contRedio pl-0" for="radioPayPal">
                                           <div class="row w-100 m-0">
                                               <div class="col-5">
                                                    <span class="checkIcon pl-3">
                                    ...
                                    <!-- <div class="paymentRadio paymentRadioMob">
                                        ...
                                        <label class="contRedio pl-0" for="radioRazorpay">
                                           <div class="row w-100 m-0">
                                               <div class="col-5">
                                                    <span class="checkIcon pl-3">
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12 col-xs-12 mt-2 text-center procRegisterBtn">
                                                    <button type="submit" name="btnPayment" class="btn btnBuyNow" title="Proceed To Payment" value="btnPayment" >
                                                        Proceed To Payment
                                                    </button>
                                                </div>
