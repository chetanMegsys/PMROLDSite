...
<body>
    ...
    <script defer>
        ...
        const stripe = Stripe("pk_test_51OYsTqAaq7JBewhTYzqsc0nKHWkkZZPxDLLqDkcUllg59Uk1lhWOEvypnqKalw13MMXs4IwNHMxyFImSbUVSVRPS00SIDViLuP");
       // rep_name
        // The items the customer wants to buy
        const items = [{ id: <?php echo $report_data['id'];?>, amount: <?php echo $report_data['rep_amount'];?> }];
