            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12">
                                <p class="h3 px-4 mb-4 text-center">Your Order Details</p>
                            ...
                            <div class="col-12 mt-4">
                            	<form action="" method="POST">
	                                ...
	                                <p class="h4 px-4 mb-4">Select License Type</p>
	                                ...
	                                <div class="paymentOption pt-4 mb-5">
                                         <p class="mb-0"><small>Report Format Available: PPT, PDF, WORD, EXCEL</small></p>
