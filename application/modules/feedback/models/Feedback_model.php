<?php
    ...
    class Feedback_Model extends CI_Model{
    	...
    	public function getReportById($id){
    		return $this->db->select("reports.rep_id,reports.rep_name,reports.rep_keyword,reports.rep_url,reports.update_date , reports.rep_pages, reports.rep_type,reports.cat_id,category.cat_name,category.seo_pagename")->from("reports")->join("category","reports.cat_id=category.category_id")->where("reports.is_custom",'N')->where("reports.rep_id",$id)->get()->result_array();
    	}

    	public function saveRequest($postData){
    		$this->db->insert("page_feedback",$postData);
