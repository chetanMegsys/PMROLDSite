...
<head>
    ...
    <main role="main">
        <section class="searchBanner py-0">
            <div class="searchBannerTop py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            ...
                            <p class="mb-5 lineheight25 font15">
            ...
            <div class="container">
                <div class="row">
                    <div class="text-center col-lg-12">
                        <span class="headIcon"></span>
                        <h2 class="borderGreenCenter secHeading mb-0">Updated Market Research Reports</h2>
                        <p class="mb-5 font15">Customized research to grab the clients’ mindshare</p>
                    </div>
                            ...
                            <div class="col-sm-12 bgGrey">
                                <div class="boxBlue text-white">
                                    <div class="p-4 text-left">
                                        ...
                                        <a class="text-white font15 lineheight25" href="<?php echo WEBSITE_URL."market-research/".$forthcoming_reports[0]['rep_url'].".asp"; ?>" title="<?php echo $keyword; ?>"><?php echo $forthcoming_reports[0]['rep_name']; ?></a>
                                        <div class="my-4">
                            ...
                            <div class="col-sm-12 bgGrey my-5">
                                <div class="boxGreen text-white">
                                    <div class="p-4 text-left">
                                        ...
                                        <h3 class="borderGreenLeft"><?php echo $keyword; ?></h3>
                                        <a class="text-white font15 lineheight25" href="<?php echo WEBSITE_URL."market-research/".$forthcoming_reports[1]['rep_url'].".asp"; ?>" title="<?php echo $keyword; ?>"><?php echo $forthcoming_reports[1]['rep_name']; ?></a>
                                        <div class="my-4">
        ...
        <section class="exploreSec bgGreen pt-3">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
       ...
       <!--  <div class="shapeTop"></div>
        ...
        <section class="trustSec pt-0 pb-0">
            <div class="container">
                <div class="row">
                ...
                <div class="trustSecRow row">
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="trustBox p-4">
                            ...
                            <div class="text-right compName font15">
        ...
        <div class="shapeRightTopNew"></div>
