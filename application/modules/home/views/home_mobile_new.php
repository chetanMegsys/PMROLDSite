...
<link rel="preload" fetchpriority="high" as="image" href="https://www.persistencemarketresearch.com/themes/image/pmr-media-citation.webp" type="image/webp">
    <link rel="preload" href="<?php echo WEBSITE_URL; ?>themes/css/theme-home-mobile.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="<?php echo WEBSITE_URL; ?>themes/css/theme-home-mobile.css"></noscript>
    <?php $this->load->view("frontend/meta_links"); ?>
    <link rel="stylesheet" href="<?php echo WEBSITE_URL; ?>themes/css/theme-home-mobile.css">
...
<!-- End Google Tag Manager -->
    ...
    <?php $this->load->view("frontend/header_home_mobile"); ?>
    <style>
        .stat{
        font-weight: 500;
        font-size: 16px;
        ...
        .stat span{ font-weight:600;color:#282C7D;}
        .mr-keyword-list {
            display: flex;
            flex-wrap: wrap;
       ...
       <section class="svgwaves_outer">
            <div class="bg-animation home_banner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" id="toggleContent1" style="background: #fff1e5;padding: 20px;">
                            <h1 class="font24 pb-2 text-blue" style="font-weight: 600;">Decide with Confidence</h1>
                            <h2 style="font-size: 1.3rem;color: #000;font-weight: 600;">Independent and Unbiased Market Research</h2>
                            <p class="font16 text-left">
                            Identify market gaps, make well informed decisions. Drive your business strategy with maximum efficiency.<br>Lead your market, don't just react to it. Explore opportunities from our industry data and analysis.<br>Derive actionable and objective insights that drive your business performance, from our comprehensive market research studies.
                            <p>
                        ...
                        <div class="col-md-6 my-4 text-center">
                                <img src="<?php echo ROOT_URL; ?>themes/image/home/pmr-hero.webp" width="330px" height="218px" style="max-width: 100%;" alt="Growth Chart By Market Research" title="Growth Chart By Market Research">
                        </div>
                    </div>
        ...
        <div class="container-fluid bg-lgray pt-3">
            ...
            <div class="row">
                <div class="col-6 pt-2">
                    <p style="font-size: 28px;font-weight:600;font-family: Times;color:#282C7D;text-align: right;">Estd. 2012</p>
                </div>
                <div class="col-6">
                <p class="stat"><span>4000+</span><br>Reports Delivered</p>
                </div>
                <div class="col-6">
                <p class="stat"><span>7450+</span><br>Research Titles</p>
                </div>
                <div class="col-6">
                <p class="stat"><span>2240+</span><br>Client's Served</p>
                </div>
            </div>
            </div>
        </div>
            ...
            <div class="container" id="toggleContent">
                <div class="row">
                    <div class="col-12">
                        ...
                        <img src="<?php echo ROOT_URL; ?>themes/image/home/data_driven_decision_making_img.webp" width="340" height="340" alt="Data Driven Decision Making" title="Image representing Data Driven Decision Making" class="dddm-img" width="100%" style="max-width: 100%;">
                        <span class="short-text">
                        <h3 class="secHeading mt-2">The Value of Market Research</h3>
        ...
        <div class="mc-row">
            <div class="container">
                <h2 class="secHeading mb-2">Media Citations</h2>
            </div>
            <a class="mc-link" href="<?php echo ROOT_URL; ?>media-citations.asp">
                <img class="service-img p-4" src="<?php echo ROOT_URL; ?>themes/image/pmr-media-citation.webp" width="100%" height="" alt="Media Citations logos" title="Media Citations logos">
            </a>
        ...
        <section class="second-section section3 pt-4">
            <div class="container">
                <h2 class="secHeading h2 py-2">Market Research Reports</h2>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <label class="font16 text-left" for="select-industry"><strong>Select Industry</strong></label>
                        <select class="form-control d-md-none mb-3" id="select-industry">
                        <option value="#latest-reports">Latest Reports</option>
                        <option value="#automotive-and-transportation">Automotive & Transportation</option>
                        <option value="#chemicals-and-materials">Chemicals & Materials</option>
                        <option value="#consumer-goods">Consumer Goods</option>
                        <option value="#energy">Energy & Utilities</option>
                        <option value="#food-and-beverages">Food & Beverages</option>
                        <option value="#healthcare">Healthcare</option>
                        <option value="#industrial-automation">Industrial Automation</option>
                        <option value="#it-and-telecommunication">IT & Telecommunication</option>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade active show" id="latest-reports" role="tabpanel" aria-labelledby="latest-reports-tab">
                                <div class="">
                                    <div class="row">
                                        <?php $cnt = 1; foreach($latest_reports as $at_latest_report){
                                            $at_keyword = "";
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research.asp"; ?>" class=" btn btn-viewall font16" title="View All Latest Reports"> View All Latest Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="automotive-and-transportation" role="tabpanel" aria-labelledby="automotive-and-transportation-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/automotive-and-transportation.asp"; ?>" class=" btn btn-viewall font16" title="View All Automotive & Transportation Reports"> All Automotive & Transportation Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="consumer-goods" role="tabpanel" aria-labelledby="consumer-goods-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/consumer-goods.asp"; ?>" class=" btn btn-viewall font16" title="View All Consumer Goods Reports"> All Consumer Goods Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="food-and-beverages" role="tabpanel" aria-labelledby="food-and-beverages-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/food-and-beverages.asp"; ?>" class=" btn btn-viewall font16" title="View All Food & Beverages Reports"> All Food & Beverages Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="chemicals-and-materials" role="tabpanel" aria-labelledby="chemicals-and-materials-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/chemicals-and-materials.asp"; ?>" class=" btn btn-viewall font16" title="View All Chemicals and Materials Reports"> All Chemicals and Materials Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="it-and-telecommunication" role="tabpanel" aria-labelledby="it-and-telecommunication-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/it-and-telecommunications.asp"; ?>" class=" btn btn-viewall font16" title="View All IT & Telecommunication Reports"> All IT & Telecommunication Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="semiconductor-electronics" role="tabpanel" aria-labelledby="semiconductor-electronics-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/semiconductor-electronics.asp"; ?>" class=" btn btn-viewall font16" title="View All Semiconductor Electronics Reports"> All Semiconductor Electronics Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="industrial-automation" role="tabpanel" aria-labelledby="industrial-automation-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/industrial-automation.asp"; ?>" class=" btn btn-viewall font16" title="View All Industrial Automation Reports"> All Industrial Automation Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="healthcare" role="tabpanel" aria-labelledby="healthcare-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/healthcare.asp"; ?>" class=" btn btn-viewall font16" title="View All Healthcare Reports"> All Healthcare Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="energy" role="tabpanel" aria-labelledby="energy-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/energy.asp"; ?>" class=" btn btn-viewall font16" title="View All Energy & Utilities Reports"> All Energy & Utilities Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="packaging" role="tabpanel" aria-labelledby="packaging-tab">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12 btn-viewall-middle text-center py-4">
                                            <a href="<?php echo ROOT_URL."market-research-report/packaging.asp"; ?>" class=" btn btn-viewall font16" title="View All Packaging Reports"> All Packaging Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="home-testimonial bg-lgray">
            <div class="container-fluid pt-4 pb-5">
                ...
                <section class="home-testimonial-bottom mb-4">
                    ...
                    <h2 class="secHeading pt-4  pb-2">Client Endorsements</h2>
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-6 style-3">
                                <div class="tour-item ">
                                    <div class="tour-desc bg-white mb-4">
                            ...
                            <div class="col-md-6 style-3">
                                <div class="tour-item ">
                                    <div class="tour-desc bg-white">
                                        ...
                                        <div class="link-name d-flex justify-content-end pt-4 pb-3 text-right">– A consulting firm based in Boston, United States.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="second-section py-4" style="background-color: #ffffff;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <a class="s-box" href="<?php echo ROOT_URL; ?>services/custom-research.asp">
                            <img src="<?php echo ROOT_URL; ?>themes/image/home/custom_research_icon.webp" width="100" height="100" alt="Custom Research Services" title="Image representing Custom Research Services" class="service-img">
                            <h2 class="s-title">
                                    Customized Research
                            </h2>
                        </a>
        ...
        <div class="container">
                <h2 class="font23 text-blue-new text-center py-4">If it’s market research,<br>we’ve got you covered!</h2>
        </div>
        <?php $this->load->view("frontend/footer_home_mobile"); ?>
        <script>
        document.getElementById("select-industry").addEventListener("change", function () {
