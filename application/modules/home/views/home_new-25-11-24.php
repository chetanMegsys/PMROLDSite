    ...
    <?php $this->load->view("frontend/header_home"); ?>
       ...
       <section class="svgwaves_outer">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="font30 py-2 mt-4 pt-4 text-white bold600">Grow with Confidence!</h1>
                        <form class="form-inline mt-2"  action="<?php echo WEBSITE_URL; ?>search" method="GET" >
                    ...
                    <a href="<?php echo WEBSITE_URL; ?>media-citations.asp">
                        ...
                        <img src="<?php echo WEBSITE_URL; ?>themes/image/home/pmr-media-citations.webp" width="394" height="226" alt="PMR Media Citations logos" title="Media Citations Logos">
                    </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3 text-center" >
                        <a class="service-title" href="<?php echo WEBSITE_URL; ?>market-research.asp">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/pmr-industry-reports.webp" width="255" height="136" alt="Image representing Industry Research Reports" title="Industry Research Reports" class="service-img">
                    ...
                    <div class="col-md-3">
                        <a class="service-title" href="<?php echo WEBSITE_URL; ?>services/custom-research.asp">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/engagement-model.webp" width="255" height="136" alt="Custom Research Services" title="Image representing Custom Research Services" class="service-img">
                            <div class="pmr-service mb-4">
                                <h2 class="service-title text-center my-2">
                    ...
                    <div class="col-md-3">
                        <a class="service-title" href="<?php echo WEBSITE_URL; ?>services/consulting-services.asp">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/pmr-consulting-services.webp" width="255" height="136" alt="Image representing Consulting Services" title="Consulting Services" class="service-img">
                            <div class="pmr-service mb-4">
                    ...
                    <div class="col-md-3">
                        <a class="service-title" href="<?php echo WEBSITE_URL; ?>services/subscription-services.asp">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/pmr-subscription-services.webp" width="255" height="136" alt="Image representing Subscription Services" title="Subscription Services" class="service-img">
                            <div class="pmr-service mb-4">
                                <h2 class="service-title text-center my-2">
        ...
        <section class="second-section section3 pt-4" style="background-color:#fff;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4 d-flex mt-4">
                        <div class="categeries bg-lblue">
                               <h3 class="font18 bold500 "><a class="font18 bold600" href="<?php echo WEBSITE_URL."market-research/".$latest_report['rep_url'].".asp"; ?>" title="<?php echo $keyword; ?>"><?php echo $keyword; ?></a>
                                </h3>
                        <p class="font16 mt-3 mb-0 report-desc"><?php echo $latest_report['rep_name']; ?>
                        </p>
                        <a class="font16 bold600 mt-2" style="display: block;text-align: right;" href="<?php echo WEBSITE_URL."market-research/".$latest_report['rep_url'].".asp"; ?>" title="<?php echo $keyword; ?>"><span>Read More →</span></a>
                        </div>
        ...
        <div class="container">
                <h2 class="text-center my-5">If it’s Market Research, we’ve got you covered!  <a href="<?php echo WEBSITE_URL."contact-us.asp"; ?>" class="btn btn-viewall font18" title="Contact Us">Contact Us</a></h2>
        </div>
      
   	<?php $this->load->view("frontend/footer_home"); ?>
   	
     <a href="#" id="scrollToTop" title="Back to top" class="">
     <img src="<?php echo WEBSITE_URL; ?>themes/image/totop-icon.svg" alt="Scroll To Top" width="24px" height="24px">
    </a>
        <link href="<?php echo WEBSITE_URL; ?>themes/css/home.css" rel="stylesheet" />
        <script src="<?php echo WEBSITE_URL; ?>themes/js/home.min.js" defer></script>
</body>
</html>
