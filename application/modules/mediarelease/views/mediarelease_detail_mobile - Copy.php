            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 prrightSide">
                        ...
                        if(isset($get_mediarelease->rep_name) && $get_mediarelease->rep_name!=''){
                        ?>
                        <div class="pressRelDetailsBanner text-center p-5 text-white">
                            <p>
                                <?php echo $get_mediarelease->rep_name; ?>
                            </p>
                            <a href="<?php echo WEBSITE_URL."market-research/".$get_mediarelease->rep_url."/toc"; ?>" class="btn btnOrange" title="Request TOC">
                                Request TOC
                            </a>
                        </div>
                        <?php
