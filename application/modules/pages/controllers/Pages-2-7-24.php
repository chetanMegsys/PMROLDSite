<?php
    ...
    class Pages extends MY_Controller{
        ...
        public function industry_research(){
        	...
        	$data['actual_canonical_url'] = WEBSITE_URL."industry_research.asp";
        ...
        public function custom_research(){
        	...
        	$data['actual_canonical_url'] = WEBSITE_URL."custom-research.asp";
            $data['meta_keword'] = "Custom Research, Persistence Market Research";
            $data['meta_description'] = "Persistence Market Research offers deeply customized market research solutions, leveraging global expertise to deliver actionable insights tailored to your unique business challenges and needs.";
            $data['meta_title'] = "Custom Research | Persistence Market Research (PMR)";
            $data['meta_dc_desc'] = "Persistence Market Research offers deeply customized market research solutions, leveraging global expertise to deliver actionable insights tailored to your unique business challenges and needs.";
        ...
        public function consulting_services(){
        	...
        	$data['actual_canonical_url'] = WEBSITE_URL."consulting-services.asp";
            $data['meta_keword'] = "Consulting Services, Persistence Market Research";
            $data['meta_description'] = "Persistence Market Research offers a suite of Consulting Services tailored to meet your specific needs, leveraging 5000+ reports across 10 industries to deliver critical insights and empower your business success.";
            $data['meta_title'] = "Consulting Services | Persistence Market Research (PMR)";
            $data['meta_dc_desc'] = "Persistence Market Research offers a suite of Consulting Services tailored to meet your specific needs, leveraging 5000+ reports across 10 industries to deliver critical insights and empower your business success.";
        ...
        public function subscription_services(){
        	...
        	$data['actual_canonical_url'] = WEBSITE_URL."subscription-services.asp";
            $data['meta_keword'] = "Subscription Services, Persistence Market Research";
            $data['meta_description'] = "Gain a competitive edge with Persistence Market Research's comprehensive subscription services: expert guidance, streamlined strategy, quarterly updates, and unlimited access to tailored market research solutions.";
            $data['meta_title'] = "Subscription Services | Persistence Market Research (PMR)";
            $data['meta_dc_desc'] = "Gain a competitive edge with Persistence Market Research's comprehensive subscription services: expert guidance, streamlined strategy, quarterly updates, and unlimited access to tailored market research solutions.";
