    ...
    <main role="main">
        ...
        <section class="aboutListSec">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <h2 class="text-center secHeading">Overview</h2>
                        <p>
                ...
                <div class="row mt-5">
                    <div class="col-md-4 col-sm-5 aboutImgBox px-0">
                        <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/about-2.png" width="361" height="320" alt="Persistence Market Research Vision and Values" title="Persistence Market Research Vision and Values" />
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 py-4 threePoints">
                        <div class="row">
                ...
                <div class="row mt-5">
                    <div class="col-md-4 col-md-push-8 col-sm-5 col-sm-push-7 aboutImgBox px-0">
                        <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/about-3.png" width="361" height="320" alt="Research Methodology" title="Research Methodology" />
                    </div>
                ...
                <div class="row mt-5">
                    <div class="col-md-4 col-sm-5 aboutImgBox px-0">
                        <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/about-1.png" width="361" height="320" alt="Our Unparalleled Research Methodologies Are Cut Above the Rest" title="Our Unparalleled Research Methodologies Are Cut Above the Rest" />
                    </div>
                    <div class="col-md-8 col-sm-7 greenBox aboutBox">
                ...
                <div class="row mt-5">
                    <div class="col-md-4 col-md-push-8 col-sm-5 col-sm-push-7 aboutImgBox px-0">
                        <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/about-4.png" width="361" height="320" alt="Careers" title="Careers" />
                    </div>
                    <div class="col-md-8 col-sm-7 col-md-pull-4 col-sm-pull-5 brownBox aboutBox">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="text-center mb-4">
                            <img class="img-fluid mx-auto" alt="Become Our Client" title="Become Our Client" src="<?php echo WEBSITE_URL; ?>assets/images/client.png" width="238" height="100" >
                        </div>
           ...
           <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 reportListing">
                        <p class="text-center secHeading mb-5">Latest Insights</p>
        ...
        <section class="pmrEverySec pt-0">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3 class="secHeading">Careers @ Persistence Market Research</h3>
                        <p>
                            We are always on the lookout for diligent people to be a part of our team. Just glance through our current openings.
                        </p>
                        <div class="careerOpenBtn">
                            <a class="openings" href="https://www.linkedin.com/company/persistence-market-research-&-consulting/jobs/" target="_blank" title="View Openings">View Openings</a>
                            <a class="btnLinkedin" href="https://www.linkedin.com/company/persistence-market-research-&-consulting/" target="_blank" title="Follow linkedin">Follow linkedin</a>
                        </div>
                    </div>
                </div>
            </div>
