    ...
    <main role="main">
        ...
        <section class="aboutListSec">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 aboutImgBox px-0">
                        <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/about-2.png" width="361" height="299" alt="Persistence Market Research Vision and Values" title="Persistence Market Research Vision and Values" />
                    </div>
                    <div class="col-md-12 col-sm-12 greenBox aboutBox">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 aboutImgBox px-0">
                        <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/about-3.png" width="361" height="299" alt="Research Methodology" title="Research Methodology" />
                    </div>
                    <div class="col-md-12 col-sm-12 brownBox aboutBox">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 aboutImgBox px-0">
                        <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/about-1.png" width="361" height="299" alt="Our Unparalleled Research Methodologies Are Cut Above the Rest" title="Our Unparalleled Research Methodologies Are Cut Above the Rest" />
                    </div>
                    <div class="col-md-12 col-sm-12 greenBox aboutBox">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 aboutImgBox px-0">
                        <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/about-4.png" width="361" height="299" alt="Careers" title="Careers" />
                    </div>
                    <div class="col-md-12 col-sm-12 brownBox aboutBox">
        ...
        <section class="clientSec pb-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="text-center mb-4">
                            <img class="img-fluid mx-auto" alt="Become Our Client" title="Become Our Client" width="238" height="100" src="<?php echo WEBSITE_URL; ?>assets/images/client.png">
                        </div>
