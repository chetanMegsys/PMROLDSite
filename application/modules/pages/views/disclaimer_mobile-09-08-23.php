...
<head>
    ...
    <main role="main">
        ...
        <section class="staticPageSec disclaimerSec pt-3 pb-0">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-12">
                        ...
                        <p class="secHeadingLeft w-100 mt-5">“Coming of the age” Disclaimers</p>
                        <p>
        ...
        <section class="staticConatctSec pb-0">
            <div class="container">
                <div class="row">
