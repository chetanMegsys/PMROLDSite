        ...
        <section class="solnByClientSec">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-1.png" width="238" height="180" alt="Persistence Market Research For Business Development" title="Persistence Market Research For Business Development" />
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-push-9 col-sm-12 text-center staticContent">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-2.png"  width="215" height="228" alt="Persistence Market Research for Business Leaders" title="Persistence Market Research for Business Leaders" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-3.png"  width="234" height="237" alt="Persistence Market Research for Channels" title="Persistence Market Research for Channels" />
                        </div>
                        <div class="col-md-9 col-sm-12">
                            <h3 class="borderBlue">
            ...
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-push-9 col-sm-12 text-center staticContent">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-4.png"  width="313" height="186" alt="Impartial Interpretations through Unparalleled Research" title="Impartial Interpretations through Unparalleled Research" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-5.png"  width="234" height="153" alt="Persistence Market Research For Marketers" title="Persistence Market Research For Marketers" />
                        </div>
                        <div class="col-md-9 col-sm-12">
                            <h3 class="borderBlue">
            ...
            <div class="bgGreen py-4">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-push-9 col-sm-12 text-center staticContent">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-6.png"  width="301" height="224" alt="Persistence Market Research for Product Innovators and Developers" title="Persistence Market Research for Product Innovators and Developers" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-7.png"  width="262" height="178" alt="Persistence Market Research for Supply Chain Leaders and Sourcing Professionals" title="Persistence Market Research for Supply Chain Leaders and Sourcing Professionals" />
                        </div>
                        <div class="col-md-9 col-sm-12">
                            <h3 class="borderBlue">
            ...
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-push-9 col-sm-12 text-center staticContent">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-8.png"  width="213" height="180" alt="Persistence Market Research for Technical Professionals" title="Persistence Market Research for Technical Professionals" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 engagementModeBox">
                        <div class="row">
                            <div class="col-md-6">
                                <img class="img-fluid" src="assets/images/engagement-model.png" width="531" height="284" alt="Engagement Model" title="Engagement Model" />
                            </div>
                            <div class="col-md-6">
