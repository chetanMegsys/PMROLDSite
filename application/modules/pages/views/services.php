...
<head>
    ...
    <main role="main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 text-white">
                        <h1 class="text-center mb-4 secHeading">Services</h1>
                        <p class="text-center">
        ...
        <section class="solnByClientSec">
            <div class="pb-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 service service-1">
                            <h2 class="borderBlue">
            ...
            <div class="shapeTop bgGreen"></div>
            <div class="bgGreen py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 service service-2 staticContent">
                            <h2 class="borderBlue">Scaling Operations</h2>
                            <p>
                            ...
                            <p>
                                ...
                                <ul class="col-md-6">
                                    <li>Getting supplier contracts reviewed</li>
                                    <li>Having customer-based communications streamlined</li>
                                    <li>Macromanaging the staff</li>
                                </ul>
                                <ul class="col-md-6">
                                    <li>Redefining/refurbishing the product and devise a strategy accordingly</li>
                                    <li>Having the business model examined</li>
                                    <li>Re-investing in the business on an aggressive note</li>
                                </ul>
                            </p>
                            <p>
            ...
            <div class="shapeBottom bgGreen"></div>
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 service service-3">
                            <h2 class="borderBlue">
             ...
             <div class="shapeRightTop bgBlue"></div>
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 service service-4 staticContent">
                            <h2 class="borderBlue">Enhanced Operational Efficiencies</h2>
                            <p>
            ...
            <div class="shapeRightBottom bgBlue"></div>
            <div class="mb-0 pt-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 service service-5">
                            <h2 class="borderBlue">
                                Driving Profit
                            </h2>
                            <p>
                            ...
                            <p>
                                ...
                                <ul>
                                    <li>Raising sales volume</li>
                                    <li>Reducing unit costs</li>
                                    <li>Minimizing overheads per unit of sale</li>
                                    <li>Increasing sales price</li>
                                </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12 text-white">
                        <h2 class="text-center mb-4 secHeading"> Solutions By Clients</h2>
                         <p class="text-center">
        ...
        <section class="solnByClientSec">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-1.webp" width="238" height="180" alt="Persistence Market Research For Business Development" title="Persistence Market Research For Business Development" loading="lazy">
                        </div>
            ...
            <div class="bgGreen py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-md-pull-3 col-sm-12 staticContent">
                            <h3 class="borderBlue">Persistence Market Research for Business Leaders</h3>
                            <p class="mb-0">
                        ...
                        <div class="col-md-3 col-md-push-9 col-sm-12 text-center staticContent">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-2.webp"  width="215" height="228" alt="Persistence Market Research for Business Leaders" title="Persistence Market Research for Business Leaders" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-3.webp"  width="234" height="237" alt="Persistence Market Research for Channels" title="Persistence Market Research for Channels" loading="lazy">
                        </div>
                        <div class="col-md-9 col-sm-12">
                            <h3 class="borderBlue">
                                Persistence Market Research for Channels
                            </h3>
                            <p>
            ...
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-md-pull-3 col-sm-12 staticContent">
                            <h3 class="borderBlue">Impartial Interpretations through Unparalleled Research</h3>
                            <p class="mb-0">
                        ...
                        <div class="col-md-3 col-md-push-9 col-sm-12 text-center staticContent">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-4.webp"  width="313" height="186" alt="Impartial Interpretations through Unparalleled Research" title="Impartial Interpretations through Unparalleled Research" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-5.webp"  width="234" height="153" alt="Persistence Market Research For Marketers" title="Persistence Market Research For Marketers" loading="lazy">
                        </div>
                        <div class="col-md-9 col-sm-12">
                            <h3 class="borderBlue">
                                Persistence Market Research for Marketers
                            </h3>
                            <p class="mb-0">
            ...
            <div class="bgGreen py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-md-pull-3 col-sm-12 staticContent">
                            <h3 class="borderBlue">Persistence Market Research for Product Innovators and Developers</h3>
                            <p class="mb-0">
                        ...
                        <div class="col-md-3 col-md-push-9 col-sm-12 text-center staticContent">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-6.webp"  width="301" height="224" alt="Persistence Market Research for Product Innovators and Developers" title="Persistence Market Research for Product Innovators and Developers" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 text-center">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-7.webp"  width="262" height="178" alt="Persistence Market Research for Supply Chain Leaders and Sourcing Professionals" title="Persistence Market Research for Supply Chain Leaders and Sourcing Professionals" loading="lazy">
                        </div>
                        <div class="col-md-9 col-sm-12">
                            <h3 class="borderBlue">
                                Persistence Market Research for Supply Chain Leaders and Sourcing Professionals
                            </h3>
                            <p class="mb-0">
            ...
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-md-pull-3 col-sm-12 staticContent">
                            <h3 class="borderBlue">Persistence Market Research for Technical Professionals</h3>
                            <p class="mb-0">
                        ...
                        <div class="col-md-3 col-md-push-9 col-sm-12 text-center staticContent">
                            <img class="img-fluid" src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-8.webp"  width="213" height="180" alt="Persistence Market Research for Technical Professionals" title="Persistence Market Research for Technical Professionals" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="staticBanner">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 text-white">
                        <h3 class="text-center mb-4 secHeading">Client Endorsements & Engagement </h3>
                        <p class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <h3 class="secHeading text-center mb-5">
                            Client Endorsements
                        </h3>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="col-md-12 engagementModeBox">
                        <div class="row">
                            <div class="col-md-6">
                                <img class="img-fluid" src="assets/images/engagement-model.webp" width="531" height="284" alt="Engagement Model" title="Engagement Model" loading="lazy">
                            </div>
                            <div class="col-md-6">
        ...
        <section class="reportList pt-0">
           <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 reportListing">
                        <p class="text-center secHeading mb-4">Latest Insights</p>
                        <?php if(isset($latest_reports)){ 
                            foreach($latest_reports as $latest_report){ ?>
                                <div class="contentBox bgGrey">
                                    ...
                                    <p class="mt-2 mb-0"><?php echo $latest_report['rep_name']; ?></p>
                                </div>
                        <?php } } ?>
                    </div>
                </div>
