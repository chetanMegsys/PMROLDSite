        ...
        <section class="solnByClientSec pb-0">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-1.png" alt="Persistence Market Research For Business Development" title="Persistence Market Research For Business Development" width="238" height="180" />
                        </div>
            ...
            <div class="bgGreen py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-2.png" alt="Persistence Market Research for Business Leaders" title="Persistence Market Research for Business Leaders" width="215" height="228" />
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-3.png" alt="Persistence Market Research for Channels" title="Persistence Market Research for Channels" width="234" height="237" />
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
                            <h3 class="borderBlue">
            ...
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-4.png" alt="Impartial Interpretations through Unparalleled Research" title="Impartial Interpretations through Unparalleled Research"  width="313" height="186" />
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-5.png" alt="Persistence Market Research For Marketers" title="Persistence Market Research For Marketers"  width="234" height="153"/>
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
                            <h3 class="borderBlue">
            ...
            <div class="bgGreen py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-6.png" alt="Persistence Market Research for Product Innovators and Developers" title="Persistence Market Research for Product Innovators and Developers" width="301" height="224" />
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-7.png" alt="Persistence Market Research for Supply Chain Leaders and Sourcing Professionals" title="Persistence Market Research for Supply Chain Leaders and Sourcing Professionals" width="262" height="178" />
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
                            <h3 class="borderBlue">
            ...
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-8.png" alt="Persistence Market Research for Technical Professionals" title="Persistence Market Research for Technical Professionals" width="213" height="180" />
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 engagementModeBox">
                        <div class="row">
                            <div class="col-md-12">
                                <img class="img-fluid" src="assets/images/engagement-model.png" alt="Engagement Model" title="Engagement Model"  width="227" height="175"/>
                            </div>
