...
<head>
    ...
    <main role="main">
        ...
        <section class="solnByClientSec pb-0">
            <div class="mb-3">
                <div class="container">
                    <div class="row">
            ...
            <div class="bgGreen mb-3 pt-4 pb-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 service service-2">
            ...
            <div class="bgBlue mb-3 pt-4 pb-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 service service-4">
        ...
        <section class="solnByClientSec pb-0">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-1.webp" alt="Persistence Market Research For Business Development" title="Persistence Market Research For Business Development" width="238" height="180" loading="lazy">
                        </div>
            ...
            <div class="bgGreen py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-2.webp" alt="Persistence Market Research for Business Leaders" title="Persistence Market Research for Business Leaders" width="215" height="228" loading="lazy">
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-3.webp" alt="Persistence Market Research for Channels" title="Persistence Market Research for Channels" width="234" height="237" loading="lazy">
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
                            <h3 class="borderBlue">
            ...
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-4.webp" alt="Impartial Interpretations through Unparalleled Research" title="Impartial Interpretations through Unparalleled Research"  width="313" height="186" loading="lazy">
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-5.webp" alt="Persistence Market Research For Marketers" title="Persistence Market Research For Marketers"  width="234" height="153" loading="lazy">
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
                            <h3 class="borderBlue">
            ...
            <div class="bgGreen py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-6.webp" alt="Persistence Market Research for Product Innovators and Developers" title="Persistence Market Research for Product Innovators and Developers" width="301" height="224" loading="lazy">
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
            ...
            <div class="py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-7.webp" alt="Persistence Market Research for Supply Chain Leaders and Sourcing Professionals" title="Persistence Market Research for Supply Chain Leaders and Sourcing Professionals" width="262" height="178" loading="lazy">
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
                            <h3 class="borderBlue">
            ...
            <div class="bgBlue py-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <img src="<?php echo WEBSITE_URL; ?>assets/images/clients/solutions-client-8.webp" alt="Persistence Market Research for Technical Professionals" title="Persistence Market Research for Technical Professionals" width="213" height="180" loading="lazy">
                        </div>
                        <div class="col-md-12 col-sm-12 mt-3">
        ...
        <!-- Client endorsement and engagements -->
        <section class="staticBanner">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-xs-12 col-md-offset-2 text-white">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 engagementModeBox">
                        <div class="row">
                            <div class="col-md-12">
                                <img class="img-fluid" src="assets/images/engagement-model.webp" alt="Engagement Model" title="Engagement Model"  width="227" height="175" loading="lazy">
                            </div>
                            <div class="col-md-12 mt-3">
                                <h3 class="borderBlue">Engagement Model</h3>
                                <p>
                    ...
                    <div class="col-md-12 bgGrey threeEngagtModeBox">
                        <p class="text-center mb-4 h4">- The Engagement Models put forth by Persistence Market Research are -</p>
                        <div class="row">
                            <div class="col-md-12">
        ...
        <section class="reportList pt-0">
           <div class="container">
                <div class="row">
                    <div class="col-lg-12 reportListing">
                        <p class="text-center secHeading mb-3">Latest Insights</p>
