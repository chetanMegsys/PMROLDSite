                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="report-heading">
                            ...
                            <p class="font14 text-black3 bold300 mt-2 lineheight24"><?php echo $report_detail[0]['rep_breadcrumb']!=''?$report_detail[0]['rep_breadcrumb']:''; ?> </p>
                            ...
                            <div class="sample-btn text-center mb-3">
                             ...
                             <div class="text-center">
                                 <a href="javascript::void(0)" class="btn btn-connect-Auth bold300  expertPopup" data-name="Ask An Expert" data-prop="ASK" data-btn="Ask An Expert" title="Ask An Expert"  data-toggle="modal" data-class="btn-orange" data-target="#cta-banner-3" title="Ask An Expert"  ><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-headset align-middle mr-1" viewBox="0 0 16 16">  <path d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z"/></svg> Ask An Expert</a>
                            </div>
                ...
                <div class="row">
                   ...
                   <!-- Third CTA Banner -->
                                <div class="CTA-lets-connect my-3">
                                    <div class="text-center">
                                        ...
                                        <div class="">
                                            <img src="<?php echo WEBSITE_URL;?>themes/image/zaid-mubarak.png" title="Zaid Sheikh" alt="Zaid Sheikh" width="95px" height="95px" class="img-fluid">
                                       </div>
                                       <div class="ml-3 mt-1">
                                        ...
                                        <a href="javascript::void(0)" class="btn btn-askexpert bold500 font14 expertPopup" title="Ask an Expert" data-toggle="modal" data-target="#cta-banner-3"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-headset align-middle mr-1" viewBox="0 0 16 16">  <path d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z"></path></svg> Ask An Expert</a>
                                    </div>
                                </div>
                  ...
                  <!-- Fourth CTA Banner -->
                            ...
                            <div class="tab-pane fade mt-4 mytabactive" id="companies">
                               ...
                               <?php echo $report_detail[0]['company']; ?> </div>
								  ...
								  <div id="faqAccordion">
									...
									<div class="card mb-3">
									  <div class="card-header p-0" id="heading<?php echo $counter; ?>">
										<h5 class="mb-0 <?php if($counter==1){ echo ''; }else{ echo 'collapsed'; } ?>" data-toggle="collapse" data-target="#collapse<?php echo $counter; ?>">
									  ...
									  <div id="collapse<?php echo $counter; ?>" class="collapse <?php if($counter==1){ echo 'show'; } ?>" data-parent="#faqAccordion" >
										<div class="card-body">
                    ...
                    <div class="col-12">
                        <aside class="right-side-section">
                            ...
                            <div class="Our-clients right-boxes pb-4 pt-0 mt-4 text-center">
                                ...
                                <img src="<?php echo WEBSITE_URL; ?>themes/image/clients-<?php echo $report_detail[0]['category_id']; ?>.svg"  width="100px" height="146px" title="<?php echo $report_detail[0]['cat_name']; ?>" alt="<?php echo $report_detail[0]['cat_name']; ?>">
                            </div>
