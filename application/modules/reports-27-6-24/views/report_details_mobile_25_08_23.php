           ...
           <div class="report-heading">
             ...
             <div class="sample-btn text-center mb-3">
               <a class="btn btn-free-sample" href="javascript::void(0);" title="Get FREE Report Sample" data-toggle="modal" data-target="#cta-banner-1">
                 <img src="<?php echo WEBSITE_URL; ?>themes/image/pdf-icon-latest.svg" width="22" height="22" title="Download PDF" alt="Download PDF" class="mr-2 img-fluid" loading="lazy">
                 Get FREE Report Sample
               </a>
             </div>

             <div class="text-center">
               <a href="javascript::void(0)" class="btn btn-connect-Auth bold300  expertPopup" data-name="Ask An Expert" data-prop="ASK" data-btn="Ask An Expert" title="Ask An Expert" data-toggle="modal" data-class="btn-orange" data-target="#cta-banner-3" title="Ask An Expert"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-headset align-middle mr-1" viewBox="0 0 16 16">
       ...
       <div class="row">
         <div class="col-12">
           <ul class="nav nav-tabs" id="myTab">
             <li class="nav-item">
               <a class="nav-link active font14 text-black2 myactiveclass" id="MarketBytes-tab" data-toggle="tab" href="#MarketBytes" title="Market Bytes">Market Bytes</a>
             </li>

             <?php if ($report_detail[0]['rep_type'] == 'N') {  ?>
               <li class="nav-item">
                 <a class="nav-link font14 text-black2 myactiveclass" id="companies-tab" data-toggle="tab" href="#companies" title="Companies">Companies</a>
               </li>
             <?php  }
              if (!empty($faqs)) { ?>
               <li class="nav-item">
                 <a class="nav-link font14 text-black2 myactiveclass" id="faq-tab" data-toggle="tab" href="#faq" title="FAQ">FAQ</a>
               </li>
             <?php } ?>
             <?php if ($report_detail[0]['rep_type'] == 'N') {  ?>
               <li class="nav-item">
                 <a class="nav-link font14 text-black2" title="ToC" href="<?php echo WEBSITE_URL; ?>market-research/<?php echo $report_detail[0]['rep_url']; ?>/toc">ToC</a>
               </li>
           ...
           <div class="tab-content" id="myTabContent">
             ...
             <div class="tab-pane fade show active mt-4 mytabactive" id="MarketBytes">
                    ...
                    ?>
                       ...
                       <div class="CTA-report-sample my-3">
                         <div class="text-center">
                           ...
                           <a href="javascript::void(0)" class="btn btn-freeReportSample bold500 text-black2" title="Get FREE Report Sample" data-toggle="modal" data-target="#cta-banner-1"><img src="<?php echo WEBSITE_URL; ?>themes/image/pdf-icon-latest.svg" width="22" height="22" title="Download PDF" alt="Download PDF" class="mr-2 img-fluid" loading="lazy"> Get FREE Report Sample</a>
                         </div>
                       </div>

                       <!--End First CTA Banner -->
                     <?php
                        break;
                      ...
                      ?>
                       <!-- Second CTA Banner  -->
                       <div class="CTA-research-methodo my-3">
                         <div class="text-center">
                           <p class=" bold500 font20 text-black">Market Research Methodology</p>
                           <p class="font14 text-black">-Perfect through Years of Diligence</p>
                           <a href="javascript::void(0)" class="btn btn-methodology bold500 font14" title="Check Research Methodology" data-toggle="modal" data-target="#cta-banner-2">
                             <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36.88 39.29" width="22" height="22" fill="currentColor" class="align-middle mr-1">
                     ...
                     <?php
                      ...
                      ?>
                       <!-- Third CTA Banner -->
                       <div class="CTA-lets-connect my-3">
                         <div class="text-center">
                           <p class=" bold500 font20 text-black mb-0">Let's Connect</p>
                           <p class="font14 text-black">Connect me to identify winning opportunities</p>
                           <div class="">
                             <img src="<?php echo WEBSITE_URL; ?>themes/image/zaid-mubarak.png" title="Zaid Sheikh" alt="Zaid Sheikh" width="95px" height="95px" class="img-fluid" loading="lazy">
                           </div>
                           <div class="ml-3 mt-1">
                             <p class="font18 text-black lineheight24">Zaid Sheikh <br><span class="font14">Client Partner</span> <span><a href="https://www.linkedin.com/in/zaid-mubarak-shaikh-l-i-o-n/" target="  _blank" title="Zaid Sheikh"><span class="linkedin"></span></a> </span></p>
                           </div>
             ...
             <div class="tab-pane fade mt-4 mytabactive" id="companies">
           ...
           <aside class="right-side-section">
             <div class="onlineUser">
               <p class="font12 mx-2 text-center mb-1 bold300">
                 <img src="<?php echo WEBSITE_URL; ?>themes/image/onlineUserSvg.png" alt="Professionals" class="img-fluid userIcon" width="15" height="15" loading="lazy"> <span class="bold500"><u><?php echo rand(200, 250); ?></u></span> Users Online
               </p>
             </div>
             ...
             <div class="PremiumReportInfo right-boxes pb-4 pt-0 mt-2">
               ...
               <div class="d-flex px-lg-3">
                 <div class="w-50 pl-4">
                   <img src="<?php echo WEBSITE_URL; ?>themes/image/report-sample-latest1.png" width="95" height="134" class="img-fluid" title="Europe Mini Scrap Metal Shredder Market" alt="Europe Mini Scrap Metal Shredder Market" loading="lazy">
                 </div>
                 <div>
             ...
             <div class="get-started-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
               ...
               <a class="btn btn-purchesReport bold500 text-black" href="<?php echo WEBSITE_URL . "checkout/" . $report_detail[0]['rep_id']; ?>" title=" <?php echo $report_detail[0]['rep_type'] == 'N' ? 'Purchase Report' : 'Pre Book'; ?>">
                 <img src="<?php echo WEBSITE_URL; ?>themes/image/purchase-report-icon.png" width="20" height="26" alt="Purchase Report" title="Purchase Report" class="mr-2 align-bottom" loading="lazy"> <?php echo $report_detail[0]['rep_type'] == 'N' ? 'Purchase Report' : 'Pre Book'; ?></a>
             </div>
             <div class="let-connect mb-3 mt-4 d-none">
               ...
               <div class="analyst-info d-flex">
                 <div class="px-2">
                   <img src="<?php echo WEBSITE_URL; ?>themes/image/Mohit-lets-connect.png" width="95px" height="95px" alt="Talk To an Expert Today" class="img-fluid" title="Mohit Loshali" loading="lazy">
                 </div>
               ...
               <div class="text-center">
                 <a href="<?php echo WEBSITE_URL . "ask-an-expert/" . $report_detail[0]['rep_id']; ?>" class="btn btn-connect-Auth bold500"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-headset align-middle mr-1" viewBox="0 0 16 16">
                     <path d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z" />
             ...
             <div class="Customization-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
               ...
               <div class="btn-container mt-2">
                 <a href="javascript::void(0)" class="btn btn-Customization btn-custo bold500 request_popup" data-name="Request for Customization" data-prop="RC" data-btn="Get Customized Report" title="Request Customization" data-toggle="modal" data-target="#talk-to-author" title="Request Customization" data-class="btn-green"><svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 
                     <path class="cls-1" d="m15.24,13.76c.57-.4,1.11-.78,1.65-1.16,2.87-2.03,5.74-4.06,8.61-6.1.79-.56,1.4-.45,1.97.34.13.18.25.35.38.53.44.65.33,1.33-.31,1.79-1.59,1.13-3.18,2.25-4.76,3.37-2.42,1.71-4.84,3.43-7.26,5.14-.73.52-1.26.43-1.79-.29-.94-1.3-1.89-2.61-2.84-3.91-.55-.75-.45-1.4.31-1.96.16-.12.32-.23.48-.35.71-.51,1.34-.41,1.87.3.56.75,1.12,1.51,1.7,2.3Z"></path>
             ...
             <div class="quickContact right-boxes px-2 pt-0 pb-0 mt-4 text-center">
               ...
               <div class="QuickContactList">
                 ...
                 <div class="contact2 contactList text-left pr-2 pl-3">
                   <a href="tel:+353-1-4434-232" class="text-black3 font14 d-flex" title="+1-646-568-7751"><span class="quickContactIMG"></span> <span class="quickContactText">+1-646-568-7751</span></a>
                 </div>
             ...
             <div class="Our-clients right-boxes pb-4 pt-0 mt-4 text-center">
               ...
               <img src="<?php echo WEBSITE_URL; ?>themes/image/clients-<?php echo $report_detail[0]['category_id']; ?>.svg" width="100px" height="146px" title="<?php echo $report_detail[0]['cat_name']; ?>" alt="<?php echo $report_detail[0]['cat_name']; ?>" loading="lazy">
             </div>
             ...
             <div class="member-of right-boxes pb-4 pt-0 mt-4 text-center">
               ...
               <a href="https://www.dnb.com/business-directory/company-profiles.persistence_market_research_private_limited.9abc6bce674200f850b02f07995c6f97.html" title="Duns Registered" target="_blank">
                 <img class="" width="104" height="85" src="<?php echo WEBSITE_URL; ?>themes/image/dun-logo-new.png" alt="Duns Registered" title="Duns Registered" loading="lazy">

               </a>

               <p class="font16 txt-black py-3 m-0 bold300 text-center">- Secured Payment -</p>
               <img class="" width="156px" height="49" src="<?php echo WEBSITE_URL; ?>themes/image/secureTrust-logo.png" alt="Secure Trust" title="Secure Trust" loading="lazy">

               <p class="font16 txt-black py-3 m-0 bold300 text-center">- Policy Compliance -</p>
               <img class="" src="<?php echo WEBSITE_URL; ?>themes/image/lms-logo.png" width="72px" height="63px" alt="GDPR" title="GDPR" loading="lazy">
           ...
           <div class="row m-0">
             <div class="col-lg-8 p-0">
               ...
               <form class="mt-4" name="" action="<?php echo $submit_url; ?>" method="POST">
                 ...
                 <div class="form-group position-relative">
                   <input type="text" name="company" id="company" class="form-control company" placeholder="Company*" required="required" pattern="^$|^\S+.*">
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                     <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                   </svg>
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
                 ...
                 <div class="form-group position-relative">
                   <textarea name="message" id="message" class="form-control message" rows="2" placeholder="<?php echo $messagePlaceholder; ?>" maxlength="200" required="required"></textarea>
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                     <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                   </svg>
                   <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
                 ...
                 <button type="submit" class="buttonMyclass btn requestFreeSample " name="btnSubmit"><span class="requestFormButton">Yes! Send a <span class="bold700 "><u>FREE</u></span> Copy</span></button>
               </form>
             </div>
           </div>
         </div>
