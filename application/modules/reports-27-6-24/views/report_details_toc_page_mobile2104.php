                    ...
                    <div class="col-12">
                        <div class="report-heading">
                            ...
                            <div class="text-center">
                                <a href="javascript::void(0)" class="btn btn-connect-Auth bold300 expertPopup" data-name="Ask An Expert " data-prop="ASK" data-btn="Ask An Expert " title="Ask An Expert " data-toggle="modal"   title="Ask An Expert "  data-toggle="modal" data-target="#cta-banner-3" data-class="btn-orange"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-headset align-middle mr-1" viewBox="0 0 16 16">  <path d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z"/></svg> Ask An Expert </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <aside class="right-side-section">
                            ...
                            <div class="let-connect mb-3 mt-4  d-none">
                                ...
                                <div class="text-center">
                                    <a href="<?php echo WEBSITE_URL."ask-an-expert/".$report_detail[0]['rep_id']; ?>" class="btn btn-connect-Auth  bold500" title="Talk To Author"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-headset align-middle mr-1" viewBox="0 0 16 16">  <path d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z"/></svg> Talk To Author</a>
                                </div>
