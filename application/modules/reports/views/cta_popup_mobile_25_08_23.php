          ...
          <div class="modal-body">
            <div class="row m-0">
              <div class="col-lg-8 p-0">
                ...
                <p class="text-center mt-4 mb-2 modalHead"><span class="bold700"><u>FREE</u></span> Report Sample is Available</p>
                <form class="mt-4" name="" action="<?php echo $submit_url; ?>" method="POST">
                  ...
                  <div class="form-group position-relative ">
                    <input type="text" name="company" id="company" class="form-control company" placeholder="Company*"  required="" pattern="^$|^\S+.*">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
            ...
            <div class="row m-0">
              <div class="col-lg-8 p-0">
                ...
                <form class="mt-4" name="" action="<?php echo $submit_url; ?>" method="POST" >
                  ...
                  <div class="form-group position-relative  ">
                    <input type="text" name="jobTitle" id="jobTitle" class="form-control jobTitle" placeholder="Job Title*" required="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
            ...
            <div class="row m-0">
              <div class="col-lg-8 p-0">
                ...
                <form class="mt-4" name="" action="<?php echo $submit_url; ?>" method="POST" >
                  ...
                  <div class="form-group position-relative">
                    <input type="text" name="JobTitle" id="JobTitle" class="form-control JobTitle jobTitle" placeholder="Job Title*" required="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
