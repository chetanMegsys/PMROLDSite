          ...
          <div class="modal-body">
            <div class="row m-0">
              ...
              <div class="col-lg-8 p-0">
                ...
                <form id="pmr_sample_report" class="mt-4" name="" action="<?php echo $submit_url; ?>" method="POST">
                  <?php
                  ...
                  <button type="submit" class="btn requestFreeSample g-recaptcha" name="btnSubmit" data-sitekey="6LfvpT4pAAAAAB0vvuW2dNarDsi10l0I-niEtm96" data-callback='onSubmit' data-badge="bottomleft" data-action='submit'>
                  <!-- <button type="submit" class="btn requestFreeSample" name="btnSubmit"> -->
                     Yes! Send a <span class="bold700"><u>FREE</u></span> Copy</button>
                </form>
              </div>
            </div>
          </div>
            ...
            <div class="row m-0">
              ...
              <div class="col-lg-8 p-0">
                ...
                <form class="mt-4" name="" action="<?php echo $submit_url; ?>" method="POST" >
                  ...
                  <!-- <input type="hidden" name="btnSubmit" value="" />
                  <button type="submit" class="btn sampleFormSubmitBtn text-black5 radius100 bold500 g-recaptcha" name="btnSubmit" data-sitekey="6LfvpT4pAAAAAB0vvuW2dNarDsi10l0I-niEtm96" data-callback='onSubmit' data-badge="bottomleft" data-action='submit'> -->
                  <button type="submit" class="btn requestFreeSample" name="btnSubmit">
                    Yes! Share Research Methodology</button>
                </form>
              </div>
            </div>
          </div>
 ...
 <p class="text-center bold400 txt-black my-3">You will receive an email from our Business Development Manager. Please be sure to check your SPAM/JUNK folder too.</p>
      ...
      <script>
        function onSubmit(token) {
            document.getElementById("pmr_sample_report").submit();
        }
     </script>
