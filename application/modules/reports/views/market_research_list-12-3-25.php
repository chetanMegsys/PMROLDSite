                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <div class="form-check d-flex align-items-center my-2">
                                                ...
                                                <label class="form-check-label txt-red" for="<?php echo $category['category_id']; ?>">
                                                ...
                                                if(!empty($category['subcategories'])){
                                                    ...
                                                    <div class="form-check d-flex align-items-center my-2 ml-3">
                                                        <input type="checkbox" class="form-check-input searchBySector category_filter searchBySel" 
                                                            ...
                                                            data-parent="<?php echo $category['category_id']; ?>"> <!-- Added data-parent -->
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".searchBySel").change(function(){
                ...
                // If parent category is checked, check all its child categories
                if ($(this).is(":checked")) {
                    $("input[data-parent='"+categoryId+"']").prop("checked", true);
                } 
                // If parent category is unchecked, uncheck all its child categories
                else {
                    $("input[data-parent='"+categoryId+"']").prop("checked", false);
                }

                // Check and update the parent's status if a child is unchecked
            ...
            function checkParentStatus(childCheckbox) {
                ...
                if (parentId) {
                    ...
                    // Check if any sibling is checked and if all are checked
