            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-xs-12 col-md-offset-2 ">
                        <h1 class="text-center mb-1 secHeading">Upcoming Market Research Reports</h1>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="row reportListing">
                                        <div class="col-xs-12 col-md-9 col-sm-8">
                                            <div class="contentBox py-0">
                                                ...
                                                <span class="report-meta"><?php echo date("j M Y", strtotime($report['update_date']));?> | Format: PPT*, PDF, EXCEL
                                                </span>
