 ...
 <head>
                 ...
                 <div class="col-md-3">
                    <div class="get-started-box right-boxes pb-4 pt-0 px-3 mt-3 text-center">
                            ...
                            Report Price <?php $su_report_price = isset($report_detail[0]['rep_price_sul'])? "$". $report_detail[0]['rep_price_sul'].'*' :'';?>
                             ...
                             <a class="btn bold500 btn-free-sample btn-block font18" href="<?php echo WEBSITE_URL . "checkout/" . $report_detail[0]['rep_id']; ?>" title="<?php echo $report_detail[0]['rep_type'] == 'N' ? 'Buy Now' : 'Pre Book'; ?>" style="border-radius: 10px; box-shadow: 3px 4px 5px #bfbfbf;background-color:#2155A4;color:#fff;">
     ...
     <section class="report-details-tabs" >
        <div class="container-fluid  py-2" style="background: #2155A4;">
            <div class="container">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="nav-item">
             ...
             <div class="row">
                     ...
                     <div class="tab-content" id="myTabContent">
                         ...
                         <div class="tab-pane fade show active mt-4" id="MarketBytes">
                             <?php
                                             ...
                                             <div class="CTA-banner1">
                                                 <div class="row">
                                                     ...
                                                     <div class="col-md-8 text-center">
                                                         ...
                                                         <a href="javascript::void(0)" class="btn btn-freeReportSample bold500 text-black2" title="Get Report Sample" data-toggle="modal" data-target="#cta-banner-1"><img src="<?php echo WEBSITE_URL; ?>themes/image/pdf-icon-latest.svg" width="22" height="22" title="Download PDF" alt="Download PDF" class="mr-2 img-fluid"> Get Report Sample</a>
                                                     </div>
                                                 </div>
                                ...
                                ?>
                            <p class="py-2 text-center" style="line-height: 12px;">For report customisation and delivery information contact our sales representative.</p>
                         </div>
                 ...
                 <div class="col-md-3">
                     <aside class="right-side-section">
                         ...
                         <div class="PremiumReportInfo right-boxes pb-4  mb-2  mt-3" style="background-color:#e3eeff;">
                             <p class="font18 text-blue-new py-2 m-0 text-center" style="font-weight:600;">Request Report Sample</p>
                             <div class="d-flex flex-row px-lg-3">
                            <form class="mt-2 sampleForm" name="" action="" method="POST" onsubmit="return validateForm();">
                            <?php
                            ...
                            <button type="submit" class="btn requestFreeSample font18" name="btnSubmit" style="background: #2155A4;padding: 9px 37px;width: 221px;border: 2px solid #2155A4;border-radius: 10px;color: #fff;font-weight: 600;"> Submit</button>
                            </form>
     ...
     <?php 
     $messagePlaceholder = "Please explain your research goal in brief for us to serve you better.";
