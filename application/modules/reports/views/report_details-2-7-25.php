 ...
 <head>
     ...
     <div class="fixed-header stickyHeader p-2">
         <div class="container report-details-tabs d-flex justify-content-between">
             ...
             <div class="sample-btn">
                <a rel="nofollow" href="<?php echo ROOT_URL; ?>enquiry/<?php echo $report_detail[0]['rep_id']; ?>" class="btn btn-enquire text-black2 mr-4" title="Enquire Now" >Enquire Now</a>
         ...
         <div class="container py-3">
             ...
             <div class="row align-items-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <?php if (isset($report_detail[0]['rep_type']) && $report_detail[0]['rep_type'] == 'N') {
                                        ?>
                            <p class="m-0 font16">Last Updated: <span class="date-mm bold600"> <?php echo $report_detail[0]['rep_type'] == 'N' ? date("j F Y", strtotime($report_detail[0]['update_date'])) : date('j F Y', strtotime(date('Y-m-d') . ' + 50 days')); ?> </span>
                            </p>
                 ...
                 <div class="col-md-2 p-0 text-left">
                    <img src="<?php echo ROOT_URL; ?>themes/image/sample_report.webp" style="border-radius:10px;margin-top:-30px;" width="172" height="231"  alt="Market Research Report">
                 </div>
                 
             </div>
             <div class="row cta-sec">
                <div class="col-sm-12 my-2" style="display: flex; justify-content: space-between; align-items: center;">
                    <div style="display: flex;">
                        <a class="btn rs-btn" style="width: 250px; margin-right: 15px; padding: 6px 10px; font-weight: 500;" rel="nofollow" title="Request Sample" data-prop="RS" href="<?php echo ROOT_URL; ?>samples/<?php echo $report_detail[0]['rep_id']; ?>">
                            Request Sample
                        </a>
                        <a class="btn request_popup rc-btn ml-5" data-prop="RC" style="width: 250px; padding: 6px 10px; font-weight: 500;" rel="nofollow" title="Request Customization" href="<?php echo ROOT_URL; ?>request-customization/<?php echo $report_detail[0]['rep_id']; ?>">
                            Request Customization
                        </a>
                    </div>
                    <div class="share-btns">
                        <a href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.persistencemarketresearch.com/market-research/<?php echo $report_detail[0]['rep_url'].'.asp&title='.$report_keyword; ?>" target="_blank" rel="noopener noreferrer" title="Linkedin" style="display: flex; align-items: center; text-decoration: none; color: #0077b5; font-weight: 600;">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="#282C7D" xmlns="https://www.w3.org/2000/svg" style="margin-right: 6px;">
                            <path d="M20.447 20.452H16.89V14.84C16.89 13.553 16.86 11.964 15.064 11.964C13.245 11.964 12.97 13.33 12.97 14.748V20.452H9.413V9H12.826V10.521H12.873C13.351 9.662 14.443 8.757 16.011 8.757C19.376 8.757 20.448 10.872 20.448 14.01V20.452H20.447ZM5.337 7.433C4.193 7.433 3.27 6.506 3.27 5.368C3.27 4.23 4.193 3.304 5.337 3.304C6.477 3.304 7.402 4.23 7.402 5.368C7.401 6.506 6.477 7.433 5.337 7.433ZM6.863 20.452H3.813V9H6.863V20.452ZM22.225 0H1.771C0.791 0 0 0.77 0 1.723V22.275C0 23.23 0.791 24 1.771 24H22.225C23.206 24 24 23.23 24 22.275V1.723C24 0.77 23.206 0 22.225 0Z"/>
                            </svg>
                        </a>
                        <a href="#" title="Print" onclick="window.print(); return false;" style="display: flex; align-items: center; text-decoration: none; color: #282C7D; font-weight: 600;">
                            <svg width="26" height="26" viewBox="0 0 24 24" fill="#282C7D" xmlns="https://www.w3.org/2000/svg" style="margin-right: 6px;">
                            <path d="M19 8H5C3.9 8 3 8.9 3 10V17H7V21H17V17H21V10C21 8.9 20.1 8 19 8ZM16 19H8V15H16V19ZM17 3H7V7H17V3Z"/>
                            </svg>
                        </a>
                        <a href="mailto:?subject=<?php echo $report_keyword; ?>&body=Check%20out%20this%20Report:%20https://www.persistencemarketresearch.com/market-research/<?php echo $report_detail[0]['rep_url'].'.asp'; ?>" title="Email" style="display: flex; align-items: center; text-decoration: none; color: #dc3545; font-weight: 600;">
                            <svg width="26" height="26" viewBox="0 0 24 24" fill="#282C7D" xmlns="https://www.w3.org/2000/svg" style="margin-right: 6px;">
                            <path d="M20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM20 6L12 13L4 6H20ZM4 18V8L12 15L20 8V18H4Z"/>
                            </svg>
                        </a>
                            <a rel="nofollow" class="btn bold600 btn-free-sample btn-block font18 btn-buy" href="<?php echo WEBSITE_URL . "checkout/" . $report_detail[0]['rep_id']; ?>" title="<?php echo $report_detail[0]['rep_type'] == 'N' ? 'Buy Now' : 'Pre Book'; ?>" style="border-radius: 10px; box-shadow: 3px 4px 5px #282C7D; background-color: #fff; color: #282C7D; width: 178px; padding: 6px 10px; font-weight: 500 !important;">
     ...
     <section class="report-details-tabs" >
        <div class="container-fluid  py-2 rtab-row" style="background: #f5f5f7;">
            <div class="container">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="nav-item">
                    ...
                    <!-- <li class="nav-item">
                        <a class="btn rs-btn" rel="nofollow" title="Get Report Sample" href="<?php echo ROOT_URL; ?>samples/<?php echo $report_detail[0]['rep_id']; ?>">
                            Request Sample
                        </a>
                    </li> -->
                </ul>
             ...
             <div class="row report-tabs">
                     ...
                     <div class="tab-content" id="myTabContent">
                         ...
                         <div class="tab-pane fade show active mt-4" id="MarketBytes">
                             <?php
                                ...
                                ?> <h2 id="<?php echo strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-', $report_desc['title']))); ?>" class="text-blue-new font20 "> <?php echo  $report_desc['title']; ?> </h2>
                                     <?php
                                        if ($image_with_title != '') {
                            ...
                            <div class="author-box">
                                <div class="row">
                                        <div class="col-md-2 col-sm-2 mb-0">
                                            <img src="<?php echo ROOT_URL.'assets/images/author/'.$get_authors->author_image;?>" width="120" height="120" loading="lazy" alt="<?php echo $get_authors->author_name;?>">
                                        </div>
                 ...
                 <div class="col-md-3 right-column">
                     <aside class="right-side-section">
                        <div class="card my-4">
                            <h2 class="font18 text-blue-new py-3 m-0 bold400 text-center">List of Contents</h2>
                            <ul class="list-group list-group-flush jtoc">
                                <?php if (!empty($report_description)) : ?>
                                    <?php foreach ($report_description as $rd_title) :
                                        $slug = strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-', $rd_title['title'])));
                                        ?>
                                        <li class="list-group-item">
                                            <a class="toc-link" href="#<?php echo $slug; ?>">
                                                <?php echo htmlspecialchars($rd_title['title']); ?>
                                            </a>
                                        </li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                        ...
                        <div class="PremiumReportInfo Our-clients right-boxes pb-4 pt-0 text-center">
                        ...
                        <div class="Customization-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
                             ...
                             <div class="btn-container">
                                 <a href="<?php echo ROOT_URL."research-methodology.asp"; ?>" class="btn btn-Customization btn-custo bold600 font18" data-name="Get Research Methodology"  title="Get Research Methodology" data-class="btn-green" style="width:100%;">
                                 Read More</a>
                             </div>
                        </div>
                         <?php
                         ...
                         <?php
                            ...
                            ?>
                             <div class="relatedReportslist px-2 pt-0 pb-4 mt-4 mb-4 right-boxes">
                                 <h2 class="font18 text-blue-new py-3 m-0 bold400 text-center">
                                    <?php  if (!empty($related_reports)) echo 'Reports By Keywords'; else echo 'Related Reports'; ?>
                                </h2>
                                 <ul class="relatedReports-ul px-2 m-0" style="list-style:none;line-height: 26px;">
                                     <?php
                         ...
                         <?php
                            ...
                            ?>
                            <div class="right-boxes pb-4 mb-2 pt-2 mt-4 sticky-right-form" style="position: sticky;top: 80px;">
                             <h2 class="font18 text-blue-new py-2 m-0 text-center" style="font-weight:600;">Request Sample</h2>
