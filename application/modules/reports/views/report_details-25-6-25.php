     ...
     <section class="report-details-topsec report-details">
         <div class="container py-3">
             ...
             <div class="row align-items-center">
                 ...
                 <div class="col-md-3">
                    <div class="get-started-box right-boxes pb-4 pt-0 px-0 mt-3 text-center">
                    ...
                    <div class="sample-btn px-0 mb-3">
                            <!-- <button class="btn request_popup rc-btn" data-name="Request Customisation" data-prop="RC" data-btn="Submit" title="Request Customisation" data-toggle="modal" data-target="#talk-to-author" data-class="btn-green" >Request Customisation
                        </button> -->
                        
                        <a class="btn request_popup rc-btn" rel="nofollow" title="Request Customisation" href="<?php echo ROOT_URL; ?>request-customization/<?php echo $report_detail[0]['rep_id']; ?>">
                     ...
                     <aside class="right-side-section">
                        ...
                        <div class="Customization-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
                         ...
                         <div class="Customization-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
                             ...
                             <div class="btn-container">
                                 <button class="btn btn-Customization btn-custo bold500 request_popup font18" data-name="Request for Customisation" data-prop="RC" data-btn="Submit" title="Request Customisation" data-toggle="modal" data-target="#talk-to-author" data-class="btn-green">
                                    Request Customisation</button>
                             </div>
                         </div>
                        <div>
