     ...
     <div class="fixed-header stickyHeader p-2">
         <div class="container report-details-tabs d-flex justify-content-between">
             ...
             <div>
                 <ul class="nav nav-tabs" id="myTab">
                     ...
                     <?php }
                        ...
                        ?>
                         <li class="nav-item ml-3">
                             <a class="nav-link font14 text-black2" href="<?php echo ROOT_URL; ?>market-research/<?php echo $report_detail[0]['rep_url']; ?>/toc" title="View ToC">Table of Content</a>
                         </li>
                     <?php } else if ($report_detail[0]['rep_type'] == 'M') {

                        ?> <li class="nav-item ml-3">
                             <a class="nav-link font14 text-black2" href="<?php echo ROOT_URL; ?>toc/<?php echo $report_detail[0]['rep_id']; ?>" title="Request ToC">Request ToC</a>
             ...
             <div class="sample-btn">
                <a href="<?php echo ROOT_URL; ?>enquiry/<?php echo $report_detail[0]['rep_id']; ?>" class="btn request_popup mr-4" title="Enquire Now" style="color: #026800;padding: 0;display: inline;font-size: 16px !important;margin: 0px;border: solid 3px #d0d000;border-radius: 5px;padding: 7px 18px;text-decoration: none;">Enquire Now</a>
                 <a class="btn btn-free-sample text-black2" title="Get Report Sample" href="<?php echo ROOT_URL; ?>samples/<?php echo $report_detail[0]['rep_id']; ?>">
                     Report Sample
                 </a>
             </div>
         </div>
                 ...
                 <div class="col-md-12">
                     <nav>
                         <ol class="breadcrumb bg-transparent p-0 my-0">
                             ...
                             <li class="breadcrumb-item">
                                 <a href="<?php echo ROOT_URL; ?>market-research.asp" class="text-blue-new" title="Persistence Market Research">
                 ...
                 <div class="col-md-3">
                    <div class="get-started-box right-boxes pb-4 pt-0 px-3 mt-3 text-center">
                            ...
                            Report Price <?php $su_report_price = isset($report_detail[0]['rep_price_sul'])? "$ ". $report_detail[0]['rep_price_sul'].'*' :'';?>
                             ...
                             <a class="btn bold600 btn-free-sample btn-block font18 btn-buy" href="<?php echo ROOT_URL . "checkout/" . $report_detail[0]['rep_id']; ?>" title="<?php echo $report_detail[0]['rep_type'] == 'N' ? 'Buy Now' : 'Pre Book'; ?>" style="border-radius: 10px; box-shadow: 3px 4px 5px #bfbfbf;background-color:#282C7D;color:#fff;">
                                 <?php echo $report_detail[0]['rep_type'] == 'N' ? 'Buy Now' : 'Pre Book'; ?></a>
                    </div>
                    <div class="sample-btn px-3 mb-3">
                        <a href="javascript::void(0)" class="btn btn-Customization btn-custo rrs-btn request_popup btn-block" data-name="Request Report Sample" data-prop="RC" data-btn="Submit" title="Request Report Sample" data-toggle="modal" data-target="#talk-to-author" data-class="btn-green">Request Report Sample
                        </a>
        ...
        <div class="container-fluid  py-2" style="background: #282C7D;">
            <div class="container">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    ?>
                        <li class="nav-item ml-3">
                            <a class="nav-link font18 text-black2 triggerToc" title="View ToC" href="<?php echo ROOT_URL; ?>market-research/<?php echo $report_detail[0]['rep_url']; ?>/toc">Table of Content</a>
                        </li>
                    <?php
                    } else  if ($report_detail[0]['rep_type'] == 'M') {
                    ?>
                        <li class="nav-item ml-3">
                            <a class="nav-link font18 text-black2" href="<?php echo ROOT_URL; ?>toc/<?php echo $report_detail[0]['rep_id']; ?>" title="Request ToC">Request Table of Content</a>
                        </li>
                 ...
                 <div class="col-md-3">
                     <aside class="right-side-section">
                        ...
                        <div class="Customization-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
                         ...
                         <div class="right-boxes pb-4 mb-2 pt-2 mt-4" style="border: 2px solid #d0d000;">
                         ...
                         <div class="get-started-box right-boxes pb-4 pt-0 mt-4 px-3 text-center">
                            <p class="font18 text-blue-new py-2 mb-0 text-center">
                             ...
                             <a class="btn btn-purchesReport text-black font18" href="<?php echo ROOT_URL . "checkout/" . $report_detail[0]['rep_id']; ?>" title="<?php echo $report_detail[0]['rep_type'] == 'N' ? 'Buy Now' : 'Pre Book'; ?>">
                                 <?php echo $report_detail[0]['rep_type'] == 'N' ? 'Buy Now' : 'Pre Book'; ?></a>
                         </div>
                         <div class="Customization-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
