         ...
         <div class="container report-details-tabs d-flex justify-content-between">
             <div class="">
                 <a class="navbar-brand p-0" href="<?php echo ROOT_URL; ?>" title="Persistence Market Research Company">
                     <img class="img-fluid" width="140" height="30.3" src="<?php echo ROOT_URL; ?>themes/image/pmr-logo.svg" alt="Persistence Market Research Company" title="Persistence Market Research Company">
                 </a>
             </div>
             <div>
                 <ul class="nav nav-tabs" id="myTab">
                     ...
                     <?php }
                        ...
                        ?>
                         <li class="nav-item">
                             <a class="nav-link font14 text-black2" rel="nofollow" href="<?php echo ROOT_URL; ?>market-research/<?php echo $report_detail[0]['rep_url']; ?>/toc" title="View Table of Content">ToC</a>
                         </li>
                     ...
                     <?php } ?>
                     <li class="nav-item">
                            <a class="nav-link font14 text-black2" rel="nofollow" title="Research Methodology" href="<?php echo ROOT_URL; ?>market-research/<?php echo $report_detail[0]['rep_url']; ?>/research-methodology">Methodology</a>
                    </li>
                 </ul>
             </div>
             <div class="sample-btn">
                <a rel="nofollow" href="<?php echo ROOT_URL; ?>request-customization/<?php echo $report_detail[0]['rep_id']; ?>" class="btn btn-enquire mr-2" title="Customize Now" >Customize Now</a>
                 <a class="btn btn-fs" rel="nofollow" title="Get Free Report Sample" href="<?php echo ROOT_URL; ?>samples/<?php echo $report_detail[0]['rep_id']; ?>">
         ...
         <div class="container pt-1 pb-2">
             ...
             <div class="row align-items-center">
                 <div class="col-md-10">
                    ...
                    <p class="d-flex bold600 font15 txt-black1 m-0">
                        ...
                        <span  class="pl-2 pr-2">
                            ...
                            <?php } ?>
                        </span><?php if($report_detail[0]['rep_type'] !== 'M') {?>|<?php }?>
                        <span class="pl-2 pr-2">
                            <?php if (isset($report_detail[0]['rep_type']) &&  $report_detail[0]['rep_type'] == 'N') {
                 ...
                 <div class="col-md-2 text-right">
                    <img src="<?php echo ROOT_URL; ?>themes/image/sample_report.webp" style="border-radius:10px;margin-top:-20px;" width="120" height="" alt="Market Growth and Regional Outlook Report by Persistence Market Research">
                 </div>
             </div>
         </div>
     </section>
            ...
            <div class="container">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="nav-item ml-0">
                        <a class="nav-link active text-black2 triggerSummary" id="summary-tab" data-toggle="tab" href="#summary" title="Summary" onclick="getFloatClick('summary-tab1');">Report Summary</a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link text-black2 tiggerSegmentation" id="segmentation-tab" data-toggle="tab" href="#segmentation" title="Segmentation" onclick="getFloatClick('segmentation-tab1');">Segmentation</a>
                    </li>
         ...
         <div class="container">
             <div class="row report-tabs">
                 <div class="col-md-9 my-3 left-column" style="background: #fff;border-radius: 10px;">
                     ...
                     <div class="tab-content" id="myTabContent">
                         ...
                         <div class="tab-pane fade show active mt-2" id="summary">
                             <?php
                                ...
                                ?> <h2 class="h2"> <?php echo  $report_desc['title']; ?> </h2>
                                     <?php
                                        if ($image_with_title != '') {
                                ...
                                ?>
                                <?php
                                    $c_full_title = $report_keyword;
                                    $pos = strpos($c_full_title, 'Market');
                                    if ($pos !== false) {
                                        $c_full_title = substr($c_full_title, 0, $pos + strlen('Market'));
                                    }
                                    ?>
                                <?php if (!empty($report_detail[0]['company'])) {?>
                                <h2 class="h2 ">Companies Covered in <?php echo $c_full_title; ?></h2>
                    ...
                    <?php } ?>
                         ...
                         <div class="tab-pane fade mt-2" id="segmentation">
                             <?php if (!empty($r_scope_data)){
                                ?><h2 class="h2  "><?php echo $r_scope_title; ?></h2>
                                <?php echo $r_scope_data;
                             }
                            ?> 
                             <?php if (!empty($key_segment_data)){
                                ?><h2 class="h2  "><?php echo $key_segment_title; ?></h2>
                    ...
                    <?php } ?>
                     <?php if (!empty($related_reports_key)) { ?>
                        <div class="relatedReportslist px-2 pt-0 pb-4 my-4">
                            ...
                            <ul class="relatedReports-ul">
                                ...
                                foreach ($related_reports_key as $related_report) {
                                    $pos = strpos($related_report['rep_keyword'], "Market");
                                    $result = ($pos !== false && $pos > 0) 
                                        ? substr($related_report['rep_keyword'], 0, $pos + strlen("Market")) 
                                        : $related_report['rep_keyword'];
                                ?>
                                    <li>
                                        <a href="<?php echo ROOT_URL . "market-research/" . $related_report['rep_url'] . ".asp"; ?>" 
                                        class="report-link" 
                                        title="<?php echo htmlspecialchars($related_report['rep_keyword']); ?>">
