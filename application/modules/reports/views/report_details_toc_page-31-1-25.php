 ...
 <head>
         ...
         <div class="container report-details-tabs d-flex justify-content-between">
             ...
             <div>
                 <ul class="nav nav-tabs" id="myTab">
                     <li class="nav-item">
                         <a class="nav-link font16 text-black2" href="<?php echo WEBSITE_URL; ?>market-research/<?php echo $report_detail[0]['rep_url']; ?>.asp" title="Market Bytes">Description</a>
                     </li>
                     ...
                     <?php }
                        ...
                        ?>
                         <li class="nav-item ml-3">
                             <a class="nav-link active font16 text-black2" data-toggle="tab" href="#TOC" title="View ToC">Table of Content</a>
                         </li>
             ...
             <div class="sample-btn">
                <a href="javascript::void(0)" class="btn request_popup mr-4" data-name="Get Discount" data-prop="RC" data-btn="Submit" title="Request Discount" data-toggle="modal" data-target="#talk-to-author" data-class="btn-green" style="color: #026800;padding: 0;display: inline;font-size: 16px !important;margin: 0px;border: solid 3px #d0d000;border-radius: 5px;padding: 7px 18px;text-decoration: none;">Promotion Offer</a>
                 <a class="btn  btn-free-sample text-black2 bold500" href="<?php echo WEBSITE_URL; ?>samples/<?php echo $report_detail[0]['rep_id']; ?>" title="Get Report Sample">
                     Get Report Sample
                 </a>
         ...
         <div class="container py-3">
                 ...
                 <div class="col-md-12">
                     <nav>
                         <ol class="breadcrumb bg-transparent p-0 my-0">
                             ...
                             <li class="breadcrumb-item" class="text-blue-new">
             ...
             <div class="col-md-9">
                    <div class="report-heading">
                         <h1 class="font28 bold600 text-blue-new mt-0 mb-3"><?php echo $report_keyword; ?></h1>
                 ...
                 <div class="col-md-3">
                    ...
                    <p class="font18 text-blue-new m-0 text-center">
                            Report Price <?php $su_report_price = isset($report_detail[0]['rep_price_sul'])? "$". $report_detail[0]['rep_price_sul'].'*' :'';?>
                             ...
                             <a class="btn bold500 btn-free-sample btn-block font18" href="<?php echo WEBSITE_URL . "checkout/" . $report_detail[0]['rep_id']; ?>" title="<?php echo $report_detail[0]['rep_type'] == 'N' ? 'Buy Now' : 'Pre Book'; ?>" style="border-radius: 10px; box-shadow: 3px 4px 5px #bfbfbf;background-color:#655639;color:#fff;">
                                 <?php echo $report_detail[0]['rep_type'] == 'N' ? 'Buy Now' : 'Pre Book'; ?></a>
                    </div>
                    <div class="sample-btn px-3 mb-3">
                        <a href="javascript::void(0)" class="btn btn-Customization btn-custo bold500 request_popup font18 btn-block" data-name="Request for Customization" data-prop="RC" data-btn="Get Customized Report" title="Request Customization" data-toggle="modal" data-target="#talk-to-author" data-class="" style="border:2px solid #026800;padding: 10px;color: #fff;border-radius: 10px;background-color:#026800;box-shadow: 3px 4px 5px #bfbfbf;"> Get Customisation
                        </a>
     ...
     <section class="report-details-tabs" >
            <div class="container-fluid  py-2" style="background: #655639;">
                <div class="container">
                <ul class="nav nav-tabs" id="myTab">
                         <li class="nav-item">
                             <a class="nav-link  font16 text-black2 triggerMarketbyte" href="<?php echo WEBSITE_URL; ?>market-research/<?php echo $report_detail[0]['rep_url']; ?>.asp" title="Market Bytes">Description</a>
                         </li>
                         <?php if ($report_detail[0]['rep_type'] == 'N') {  ?>
                             <li class="nav-item ml-3">
                         ...
                         <?php if ($report_detail[0]['rep_type'] == 'N') {
                            ...
                            ?>
                             <li class="nav-item ml-3">
                                 <a class="nav-link font16 text-black2 triggerToc active show" id="TOC-tab" data-toggle="tab" href="#TOC" title="View ToC">Table of Content</a>
                             </li>
                         <?php
                ...
                <div class="row">
                 <div class="col-md-9">
                     ...
                     <div class="tab-content" id="myTabContent">
                         ...
                         <div class="tab-pane fade show active  mt-4" id="TOC">
                             <div class="mb-5">
                             <h2 class="text-blue-new font20 ">Table of Content</h2>
                                 ...
                                 <div class="CTA-banner1">
                                     <div class="row">
                                         ...
                                         <div class="col-md-8 text-center">
                                             <p class="text-black2 font23 bold500 mb-0"><span class="bold700"></span> Report Sample is Available</p>
                 ...
                 <div class="col-md-3">
                     <aside class="right-side-section">
                         ...
                         <div class="PremiumReportInfo right-boxes pb-4  mb-2  mt-3" style="background-color:#fff;">
                             <p class="font18 text-blue-new py-3 m-0 text-center" style="font-weight:600;">Request Report Sample</p>
                             <div class="d-flex flex-row px-lg-3">
                                <form class="mt-2 sampleForm" name="" action="<?php echo $submit_url; ?>" method="POST" onsubmit="return validateForm();">
                                    <?php
                                    ...
                                    <div class="form-group position-relative">
                                    <textarea type="text" name="message" id="idName" class="form-control message" rows="2" placeholder="Your Requirements" maxlength="200" ></textarea>
                                    ...
                                    <button type="submit" class="btn requestFreeSample font18" name="btnSubmit" style="background: #026800;padding: 9px 37px;width: 221px;border: 2px solid #026800;border-radius: 10px;color: #fff;font-weight: 600;"> Submit</button>
                                </form>
                             </div>
                         </div>
                         ...
                         <div class="Customization-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
                             <p class="font18 text-blue-new py-3 m-0 bold500 text-center"> Customisation</p>
                             <p class="font16 bold400">Get our research tailor-made to suit your business requirement
                             </p>
                             <div class="btn-container">
                                 <a href="javascript::void(0)" class="btn btn-Customization btn-custo bold500 request_popup font18" data-name="Request for Customization" data-prop="RC" data-btn="Get Customized Report" title="Request Customization" data-toggle="modal" data-target="#talk-to-author" data-class="">
                         ...
                         <div class="Our-clients right-boxes pb-4 pt-0 mt-4 text-center">
                             ...
                             <img src="<?php echo WEBSITE_URL; ?>themes/image/home/pmr-media-citations.webp" title="<?php echo $report_detail[0]['cat_name']; ?>" width="210" height="120" alt="<?php echo $report_detail[0]['cat_name']; ?>">
                         </div>
                         <div class="Customization-box right-boxes pb-4 pt-0 px-3 mt-4 text-center">
                             <p class="font18 text-blue-new py-3 m-0 bold500 text-center"> Delivery Timeline </p>
                             <p class="font16 bold400">For report customisation and delivery information contact our sales representative
                             </p>
                             <div class="btn-container">
                                 <a href="javascript::void(0)" class="btn btn-Customization btn-custo bold500 request_popup font18" data-name="Enquire" data-prop="RC" data-btn="Get Customized Report" title="Enquire" data-toggle="modal" data-target="#talk-to-author" data-class="" style="width: 100%;">
                                 Enquire</a>
                             </div>
                         </div>
                         <div class="relatedReportslist px-2 pt-0 pb-4 mt-4 mb-4 right-boxes">
                                 <p class="font18 text-blue-new py-3 m-0 bold400 text-center"> Testimonials</p>
                                 <div class="font16 px-2">“Persistence Market Research has helped us immensely in compiling a sound database. Our expectations were exceeded by Persistence Market Research.”</div>
                                        
                                <div class="link-name d-flex font15 justify-content-end p-2">– Fortune 500 Telecom Company</div>
                                 
                        </div>
                         <div class="member-of right-boxes pb-4 pt-0 mt-4 mb-4 px-3 text-center">

                             <p class="font18 text-blue-new py-3 m-0 bold400 text-center">Member Of</p>
                         ...
                         <div class="col-lg-8 p-0">
                             ...
                             <form class="mt-4" name="" action="<?php echo $submit_url; ?>" method="POST" onsubmit="return gc_validateForm();">
                                ...
                                <input type="text" name="fname" style="height:0px;width:0px;border: none;display: inherit;background: transparent;" class="fname" value="">
                                 ...
                                 <div class="form-group position-relative">
                                     <input type="text" name="phoneNo" id="idFctMRContactNo" class="form-control phNo" placeholder="Phone: +1 123 456 7890"  maxlength="14" pattern="^$|^\S+.*" onblur="checksubmit(this.value);">
                                     <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                                         <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                                     </svg>
                                     <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
