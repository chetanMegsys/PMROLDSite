...
<head>
    ...
    <main role="main">
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-10 col-lg-offset-1">
                        ...
                        <form class="form-inline">
                            ...
                            if(!empty($categories)){
                            ?>
                            <div class="col-sm-6 <?php if($page_heading == 'Forthcoming Reports'){ ?>col-sm-offset-3<?php } ?>">
                            ...
                            if($page_heading != 'Forthcoming Reports'){
                            ?>
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <span class="input-group-addon">
                ...
                <div class="row">
                    ...
                    if($total_records > 0){
                    	...
                    	<div class="col-xs-12 col-lg-10 col-lg-offset-1 reportListBox">
                            <div class="paginationBox row checkReportList">
                            ...
                            <div class="reportListContainer checkReportList">
                        	<?php
                            if(!empty($reports)){
	                        ...
	                        <div class="paginationBox row checkReportList">
	                            <nav class="col-xs-12 col-md-9 col-sm-8 paginationDiv text-center">
	                                <?php echo $pagination; ?>
	                            </nav>
        ...
        <section class="keyBenifitSec text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <h3 class="secHeading mb-5">The Persistence Market Research Benefits</h3>
                    </div>
