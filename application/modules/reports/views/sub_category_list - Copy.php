...
<head>
    ...
    <main role="main">
        ...
        <section class="reportListSec">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-12 reportListBox">
                    <?php  
                    if($total_records > 0){
                        ?>
                                    ...
                                    <div class="col-xs-12 col-md-3 col-sm-4">
                                        <div class="iconBox text-center">
                                            <?php if(isset($report['rep_type']) && $report['rep_type']=='M'){
                                                ?><img src="<?php echo WEBSITE_URL; ?>assets/images/upcoming-report-cover.jpg" alt="<?php echo $keyword; ?>" width="110" height="137" title="<?php echo $keyword; ?>" /><?php
                                            }else{
                                                ?><img src="<?php echo WEBSITE_URL; ?>assets/images/publish-report-cover.jpg" alt="<?php echo $keyword; ?>" width="110" height="137" title="<?php echo $keyword; ?>" /><?php
                                            } ?>
