                                ...
                                <div class="bg-grey1 radius15 py-3 px-5 my-3 mx-5 form-section">
                                    ...
                                    <form action="" method="post" name="" onsubmit="">
                                        ...
                                        <div class="form-group col-md-12  position-relative">
                                            <input type="text" name="name" id="idName1" class="form-control name name1" placeholder="Full Name*" required="" pattern="^$|^\S+.*">
                                            ...
                                            <div class="form-group col-md-6 position-relative">
                                                <input type="text" name="phoneNo" id="idFctMRContactNo" class="form-control phNo" required="required" placeholder="Phone Number*" maxlength="14" onblur="checksubmit(this.value);" pattern="^$|^\S+.*">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                                                </svg>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
                                    ...
                                    <div class="form-group">
                                        <textarea id="message1" name="message" class="form-control" rows="2"   placeholder="Describe your interest to the analyst in a few sentences"></textarea>
                                    </div>
