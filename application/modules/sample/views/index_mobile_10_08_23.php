                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="bg-grey1 radius15 py-3 px-3 mt-4 mb-3 form-section">
                            ...
                            <form action=""   method="post" name="" onsubmit="return validateForm();" >
                                ...
                                <div class="">
                                    <div class="firstFormDiv bg-white p-3 mb-3 radius10">
                                         <div class="form-group position-relative">
                                            <input type="text" name="name" id="idName1" class="form-control name" placeholder="Full Name*" pattern="^$|^\S+.*" required="">
                                    ...
                                    <div class="secondFormDiv bg-white p-3 mb-0 radius10">
                                        <div class="form-group position-relative">
                                            <input type="text" name="phoneNo" id="idFctMRContactNo" class="form-control phNo" required="required" placeholder="Phone Number*" maxlength="14" pattern="^$|^\S+.*" onblur="checksubmit(this.value);">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                                            </svg>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="text" name="company" id="idCompanyName" class="form-control company" placeholder="Company Name*" required="" pattern="^$|^\S+.*">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#5dbb2d" class="bi bi-check-circle-fill" viewBox="0 0 16 16" style="display:none">
                                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                                            </svg>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#f53131" class="bi bi-info-circle" viewBox="0 0 16 16" style="display:none">
                                ...
                                <p class="font12 text-center text-grey1 pb-5 pt-3 mb-5">Your personal details are safe with us.
                                    <a href="<?php echo WEBSITE_URL; ?>privacy-policy.asp" title="Privacy Policy" target="_blank" class="text-blue2"> Privacy Policy</a>
                                </p>
            ...
            <div class="modal-body pmrPopUpBG text-center p-0">
                <div class="modal_Header pb-5 px-5">
                    ...
                    <div class="yesBtnDivMob mb-3">
                        <a href="<?php echo WEBSITE_URL; ?>checkout/<?php echo $reportData[0]['rep_id']; ?>?promo=P20">
                        <button class="btn">
