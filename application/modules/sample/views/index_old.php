                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent p-0 my-0">
                                ...
                                <li class="breadcrumb-item" class="text-black" aria-current="page">
                                    <span>Cloud Collaboration Market</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-3 col-md-3">
                        <div class="onlineUser">
                            <p class="font12 mx-2 text-right mb-1 bold300">
                                <img src="<?php echo WEBSITE_URL; ?>themes/image/onlineUserSvg.png" alt="Professionals" class="img-fluid userIcon" width="15" height="15"> <span class="bold500"><u>121</u></span> Users Online
                            </p>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    <div class="col-md-9">
                        <div class="report-heading">
                            <h1 class="font27 text-black2 bold300 my-3">Cloud Collaboration Market</h1>
                            <h2 class="font15 text-black3 bold300">Market Study on Cloud Collaboration: Extensive adoption across Small and Medium-sized companies to propel Expansion</h2>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="bg-grey1 radius15 py-3 px-5 mt-4 mb-3 mx-5 form-section">
                                    <div class="text-center">
                                        <h3 class="font24 mb-4 bold400 text-black4">Free Report Sample is available!</h3>
                                    ...
                                    <p class="font12 mx-2 text-center mb-1 bold300">
                                        <img src="<?php echo WEBSITE_URL; ?>themes/image/userSVG.svg" alt="Professionals" class="img-fluid userIcon" width="18" height="18"> From 121 active users, <span class="bold500"><u>12</u></span> have submitted this form
                                        </p>
                                    </div>
                                </form>
                                </div>
