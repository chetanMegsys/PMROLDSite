            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <p class="text-center mb-4 borderBlueCenter h3">Next-Gen Sectors</p>
                    </div>
                </div>
                ...
                if(!empty($categories)){
                	...
                	foreach($categories as $category){
                		if($counter == 1){
			                ...
			                ?>
			                <div class="row mt-5">
			                    <div class="col-md-4 catImgBox px-0">
			                        <img class="img-responsive mx-auto" src="<?php echo WEBSITE_URL; ?>assets/images/category/<?php echo $category['seo_pagename']; ?>.png" width="292" height="237" alt="<?php echo $category['cat_name']; ?>" title="<?php echo $category['cat_name']; ?>">
			                    </div>
			                    ...
			                    <div class="col-md-12 col-sm-12 reportListing bgGrey py-4">
			                        <div class="contentBox px-0">
			                            <h3 class="mt-0">
			                                <a class="listTitle secHeadingLeft" href="<?php echo WEBSITE_URL."market-research/".$category['rep_url'].".asp"; ?>" title="<?php echo ucwords(str_replace("-"," ",$category['rep_url'])); ?>"><?php echo ucwords(str_replace("-"," ",$category['rep_url'])); ?></a>
			                            </h3>
			                ...
			                ?>
			                <div class="row mt-5">
			                    <div class="col-md-4 col-md-push-8 catImgBox px-0">
			                        <img class="img-responsive mx-auto" src="<?php echo WEBSITE_URL; ?>assets/images/category/<?php echo $category['seo_pagename']; ?>.png" width="292" height="237" alt="<?php echo $category['cat_name']; ?>" title="<?php echo $category['cat_name']; ?>">
			                    </div>
