                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="multiClientBox">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p><?php echo $latest_report['rep_name']; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php
                    ...
                    <div class="bgGrey col-lg-10 col-lg-offset-1 resDemandBox">
                        <div class="row">
                            <div class="col-lg-6 col-md-12 px-0">
                                <div class="reserachImg bgGrey p-5">
                                    <?php $keyword = ucwords(str_replace("-"," ",$forthcoming_reports[0]['rep_url'])); ?>
                                    <img class="img-responsive" src="<?php echo WEBSITE_URL; ?>assets/images/research/research-cat-<?php echo $forthcoming_reports[0]['cat_id']; ?>.jpg" width="428" height="461" alt="<?php echo $keyword; ?>" title="<?php echo $keyword; ?>">
                            ...
                            <div class="col-lg-6 col-md-12 bgGrey py-lg-5 pr-5 pl-lg-0 pl-5 pb-5">
                                <div class="boxBlue text-white">
                                    <?php $keyword = ucwords(str_replace("-"," ",$forthcoming_reports[1]['rep_url'])); ?>
                                    <div class="p-4 text-left">
                                        <h3 class="borderGreenLeft"><?php echo $keyword; ?></h3>
                                        <a class="text-white" href="<?php echo WEBSITE_URL."market-research/".$forthcoming_reports[1]['rep_url'].".asp"; ?>" title="<?php echo $keyword; ?>">
                                ...
                                <div class="boxGreen text-white mt-5">
                                    <?php $keyword = ucwords(str_replace("-"," ",$forthcoming_reports[2]['rep_url'])); ?>
                                    <div class="p-4 m-2 text-left">
                                        <h3 class="borderGreenLeft"><?php echo $keyword; ?></h3>
                                        <a class="text-white" href="<?php echo WEBSITE_URL."market-research/".$forthcoming_reports[2]['rep_url'].".asp"; ?>" title="<?php echo $keyword; ?>">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center mb-sm-5">
                        <span class="headIcon mx-auto"></span>
                        <h2 class="borderGreenCenter secHeading">
                            Instilling Trust and Inspiring Confidence with Insinuating research and investigative Approach 
                        </h2>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 aboutContent">
                        <img class="img-responsive" src="<?php echo WEBSITE_URL; ?>assets/images/about-us.jpg"   width="352" height="335"  alt="About Persistence Market Research
