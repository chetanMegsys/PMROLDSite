                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        ...
                        <div class="row no-gutters">
                        	...
                        	?>
                            <div class="col-md-6 prFirstImg bgColorBox">
                                <div class="boxContentAbso">
                                    <p class="mb-0">Media Releases</p>
                                    <h3 class="mt-0 mb-2">
                                        <a href="<?php echo isset($media_releases[0]['url']) ? WEBSITE_URL."mediarelease/".$media_releases[0]['url'].".asp" : ''; ?>" title="<?php echo isset($media_releases[0]['name']) ? $media_releases[0]['name'] : ''; ?>">
                            ...
                            <div class="col-md-6 bgGreen bgColorBox prLastBox">
                                <div class="boxContentAbso">
