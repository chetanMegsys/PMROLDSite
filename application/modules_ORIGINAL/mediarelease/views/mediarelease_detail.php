        ...
        <div class="breadCrumb mb-0">
            <div class="container">
                <ol class="list-inline mb-0">
                    ...
                    <li>
                        <a href="<?php echo WEBSITE_URL."media-releases.asp"; ?>" title="Media Release">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-xs-12 text-white">
                        ...
                        <p>
                            Published On : <?php echo date("M d, Y",$get_mediarelease->creation); ?>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                   <div class="col-md-8 col-sm-12">
                       <div class="bg-white px-5 py-4">
                           ...
                           ?>
                           <div class="boxPurpleSec text-white">
                               <div class="row">
                                   <div class="col-sm-9 col-xs-12">
                                       ...
                                       <div class="mt-4">
                                           <a href="<?php echo WEBSITE_URL."samples/".$get_mediarelease->rep_id; ?>" class="btn btnGreen" title="Request Sample" target="_blank">
                                               Request Sample
                                           </a>
                                       </div>
                                   </div>
                                   <div class="col-sm-3 col-xs-12 imgBox">
                                       <img src="<?php echo WEBSITE_URL; ?>assets/images/report-cover.png" alt="<?php echo ucwords(str_replace("-"," ",$get_mediarelease->rep_url)); ?>" title="<?php echo ucwords(str_replace("-"," ",$get_mediarelease->rep_url)); ?>" />
                                   </div>
                               </div>
                           </div>
                           <?php
                    ...
                    <div class="col-md-4 col-sm-12 prrightSide">
                        ...
                        if(isset($get_mediarelease->rep_name) && $get_mediarelease->rep_name!=''){
                        ?>
                        <div class="pressRelDetailsBanner text-center p-5 text-white mb-5">
                            <p>
                                <?php echo $get_mediarelease->rep_name; ?>
                            </p>
                            <a href="<?php echo WEBSITE_URL."market-research/".$get_mediarelease->rep_url."/toc"; ?>" class="btn btnOrange" title="Request TOC" target="_blank">
                                Request TOC
                            </a>
                        </div>
                        <?php
