            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12  text-center text-white">
                        ...
                        <p class="text-left">Get on to the ‘New’ gear with Persistence Market Research’s latest offering of “New Events with Service”</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <p class="secHeading borderBlueCenter text-center">News</p>
                    </div>
                    <div class="col-md-12 col-sm-12 newsListPadding">
                        <ul class="list-unstyled inTheNewsList">
	                       ...
	                       if(!empty($allnews)){
	                            ...
	                            <li class="row">
	                                ...
	                                <div class="col-md-12 col-sm-12 newsReadMore">
