            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        ...
                        <p class="secHeadingLeft w-100 mt-5">Through Call:</p>
                        <p>
                            <ul>
                                <li>
                                ...
                                <li>
                                    ...
                                    <a class="" href="tel:+1 800-961-0353" title="+1-646-568-7751">
                                        +1-646-568-7751
                                    </a>
                                </li>
                                <li>
                        ...
                        <p class="secHeadingLeft w-100 mt-5">Through Mail:</p>
                        <p>
                            <ul>
                        ...
                        <p class="secHeadingLeft w-100 mt-5">What’s more?</p>
                        <p>
