            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <p class="secHeadingLeft w-100">
                            We would advise you to carefully go through the terms governing our return policy prior to buying:
                        </p>
                        <ul>
                            <li>
                                Persistence Market Research (PMR) charges the user for content and services as displayed on its official site. There would be 0% discrepancy on this count. It needs to be noted that the buyer is responsible for paying all the custom duties and taxes (use, property, sales, etc.).
                            </li>
                            <li>
