            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        ...
                        <p class="secHeadingLeft w-100 mt-5">Right to “Copyright”</p>
                        <p>
                        ...
                        <p class="secHeadingLeft w-100 mt-5">Physical Delivery:</p>
                        <p>
                        ...
                        <p class="secHeadingLeft w-100 mt-5">Online Delivery:</p>
                        <p>
                            The published report will reach you by mail within 2-12 hours of payment received.
                        </p>

                        <p class="secHeadingLeft w-100 mt-5">Customization:</p>
                        <p>
                           <strong>Persistence Market Research (PMR)</strong> does provide customization in the market reports as per your requirements. However, how soon could the customization reach you will be decided by our analysts keeping time deadlines, expected complexity, and specialties of customization asked for.  
                        </p>

                        <p class="secHeadingLeft w-100 mt-5">Annulment and Refund:</p>
                        <p>
                        ...
                        <p class="secHeadingLeft w-100 mt-5">Coverage:</p>
                        <p>
                        ...
                        <p class="secHeadingLeft w-100 mt-5">Law of the Land:</p>
                        <p>
