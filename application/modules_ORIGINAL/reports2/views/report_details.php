            ...
            <div class="reportBannerBtns col-md-12 col-lg-9 col-xs-12">
              <div class="row">
                ...
                <div class="col-sm-4 col-xs-6 reportrBtns">
                    <?php if($report_detail[0]['rep_type']=='N'){ ?>
                        <a href="<?php echo WEBSITE_URL."market-research/".$report_detail[0]['rep_url']."/toc"; ?>" class="btn btnAskExpert" title="View TOC"><span>View TOC</span></a>
                    <?php }else{ ?>
                        <a href="#" data-toggle="modal" data-target="#customModal" onclick="requestForm('T')" class="btn btnAskExpert" title="Request TOC"><span>Request TOC</span></a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 col-xs-6 reportrBtns">
                ...
                <div class="col-sm-4 col-xs-12 reportrBtns">
                  <?php if($report_detail[0]['rep_type']=='N'){ ?>
                      <a href="<?php echo WEBSITE_URL; ?>samples/<?php echo $report_detail[0]['rep_id']; ?>" class="btn btnReqSample" title="Get FREE Sample">Get FREE Sample</a>
                  <?php }else{ ?>
            ...
            <div class="col-md-8 col-lg-9 col-xs-12">
              <?php
                ...
                if(!empty($report_description)){
                    ...
                    ?>
                <section id="section-<?php echo $section_counter++; ?>" class="reportDescBox pt-4">
                  <?php
				...
				<!-- CTA Third -->
                        <div class="title-font my-5">
                            <div class="methodology-research-box">
                              <img src="<?php echo WEBSITE_URL; ?>assets/images/methodo-banner.png" class="img-responsive" width="670" height="145" alt="Research Methodology">
                              <div class="methodology-research">
                                    <p class="h4">PMR's Methodology perfected through </br> Years of Diligence </p>
                ...
                <div class="clearfix"></div>
				 ...
				 <!-- CTA First -->
                        <div class="findout-more-block my-5 pt-4 text-center">
                           <img src="<?php echo WEBSITE_URL; ?>assets/images/Vector Smart Object.png"  width="670" height="123" alt="Get Free Sample CTA" title="Find Out More about the Report Coverage"/>
                           <div class="row">
                               <div class="col-lg-6">
                                   <p class="h4">Find Out More about the Report Coverage</p>
                               </div>
                               <div class="col-lg-6">
                                
                                    <a href="#" data-toggle="modal" data-target="#customModal" onclick="requestForm('S')"  class="btn findout-more-block-smp-btn" title="Get FREE Sample"> Get FREE Sample</a>
...
<!-- CTA Second -->
                        <div class="title-font my-5">
                            ...
                            <div class="customizeReport text-center mt-5">
                                <img src="<?php echo WEBSITE_URL; ?>assets/images/Rectangle 692.png" class="img-resposive" width="670" height="123" alt="Free Customization" title="Free Customization"/>
                            
                                <div class="row customizeReport-text">
                                    <div class="col-md-1"></div>
                                    <div class="col-md-5 col-lg-4 mx-auto">
                                        <p class="h4">Customize this Report</p>
 ...
 <!-- CTA Second -->
                ...
                <div class="clearfix"></div>
						...
						<div class="ask-expert-section text-center my-5 ">
            ...
            <div class="col-md-4 col-lg-3 col-xs-12 pt-4">
                ...
                <div class="reportLink">
                  ...
                  <ul class="list-unstyled" id="reportLinkList">
                    <?php
                      if(!empty($report_description)){
                          ...
                          foreach($report_description as $report_desc){
                              ?>
                    <li>
                      <p class="repLinkSapn <?php echo $section_counter==1 ? 'active' : ''; ?>" data-target="section-<?php echo $section_counter; ?>">
                    ...
                    <?php
                      ...
                      ?>
                    <li>
                      <p class="repLinkSapn active" data-target="section-m-desc">
    ...
    <script>
      ...
      function requestForm(type){
          ...
          switch(type){
              ...
              case "S":
               ...
               case "B":
                  $(".cls_div_captcha").hide();
                  $(".requestFormTitle").html("Get <span style='color:#df9926'>FREE</span> Brochure of this Report");
                  $(".submit-btn-text span").text("Get It Now");
                  break;
      ...
      $(document).ready(function(){
          ...
          /*$("body").on("click",".request-customize-Btn", function(){
            $(".submit-btn-text span").text("Get a Free Quote");
          })*/
      });
    </script>
