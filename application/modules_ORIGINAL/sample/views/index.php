                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-field">
                                            ...
                                            <input type="text" name="captcha" class="captcha-input form-control txtCaptcha" id="captcha-form" placeholder="*Security Code" maxlength="3" size="3" tabindex=3 required />
