                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-field">
                                            ...
                                            <textarea id="message" name="message" class="form-control" maxlength="200"></textarea>
                                        </div>
                                    </div>
                                    <?php if($enqType != 'S' && $enqType != 'T'){ ?>
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-field">
                                            <span id="captcha" class="captcha"></span>
                                            <input type="text" name="captcha" class="captcha-input form-control txtCaptcha" id="captcha-form" maxlength="3" size="3" tabindex=3 placeholder="*Security Code" required />
