<?php 
    ...
    class Sitemap extends MY_Controller{
        ...
        public function xml_sitemapmain(){
            $sitemap = "<urlset xmlns='http://www.sitemaps.org/schemas/sitemap/0.9' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xsi:schemaLocation='http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd'>";
            $sitemap .= "<url><loc>".WEBSITE_URL."</loc><changefreq>daily</changefreq><priority>1.0</priority></url>";

            $result = $this->sitemap_model->getcategoryList();
            foreach($result as $value)
            {
                $sitemap .= "<url>
                        <loc>".WEBSITE_URL."market-research-report/".$value['seo_pagename'].".asp</loc>
                        <lastmod>" . date('Y-m-d',strtotime($value['added_date'])) . "T11:11:11+00:00</lastmod>
                    </url>";
            }

            $sitemap .= "<url><loc>".WEBSITE_URL."forthcoming-reports.asp</loc><changefreq>daily</changefreq></url>";
            $sitemap .= "<url><loc>".WEBSITE_URL."market-reports.asp</loc><changefreq>daily</changefreq></url>";
            $sitemap .= "<url><loc>".WEBSITE_URL."market-research.asp</loc><changefreq>daily</changefreq><priority>0.5</priority></url>";
            $sitemap .= "<url><loc>".WEBSITE_URL."market-research-report</loc><changefreq>daily</changefreq><priority>0.9</priority></url>";
            ...
            $sitemap .= "<url><loc>".WEBSITE_URL."solutions-by-clients.asp</loc><changefreq>daily</changefreq><priority>0.6</priority></url>";
            $sitemap .= "<url><loc>".WEBSITE_URL."services.asp</loc><changefreq>daily</changefreq><priority>0.6</priority></url>";
            $sitemap .= "<url><loc>".WEBSITE_URL."client-endorsement-and-engagement.asp</loc><changefreq>daily</changefreq><priority>0.6</priority></url>";
        ...
        public function sitemap_article(){
            ...
            if(!empty($articles)){
                foreach($articles as $article){
                    ...
                    $sitemap .= "<url><loc>".strtolower(WEBSITE_URL."article/".$article->url)."</loc> <lastmod>" . date('Y-m-d',strtotime($modify_date)) . "T11:11:11+00:00</lastmod><priority>0.8</priority></url>";
                }
            }
            ...
            if(!empty($result)){
                foreach($result as $report){
                    ...
                    $feed .= "<item>
                                ...
                                <pubDate>".date("m-d-Y",strtotime($report->rep_pub_date))." GMT</pubDate>
                            </item>";
                }
            }
