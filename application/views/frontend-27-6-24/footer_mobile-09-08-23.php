            ...
            <div class="container">
                ...
                <div class="row phone-no">
                    <div class="col-6 call-sec text-center text-white">
                        <a class="text-white callInfo" href="tel:+18009610353" title="+1 800-961-0353">
                            ...
                            <p class="text-white mb-1">U.S. Canada Toll-free</p>
                            <p class="text-white">+1 800-961-0353</p>
                        </a>
                    </div>
                    <div class="col-6 text-center">
                        <a class="text-white callInfo" href="tel:+16465687751" title="+1-646-568-7751">
                            ...
                            <p class="text-white mb-1">U.S. Phone </p>
                            <p class="text-white">+1-646-568-7751</p>
                        </a>
                    </div>
                </div>
                <div class="Mail-sec">
                    ...
                    <div class="row copyrightSec">
                        ...
                        <div class="col-md-12 text-center my-3">
                            <div class="paymentOpt">
                                ...
                                <img class="img-fluid mx-auto" src="<?php echo WEBSITE_URL; ?>themes/image/ABOUT-TRUST-ONLINE.svg" width="186" height="126" alt="Persistence Market Research Payment Options" title="Persistence Market Research Payment Options">
                            </div>
                        </div>
                    </div>
                </div>
