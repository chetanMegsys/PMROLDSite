...
<div class="cookiesHeader">
    <div class="cookiesInfo">
        ...
        <span>
            <button class="btn btnPrimary mx-2" style="color: #fff;background: #282C7D;border:1px solid #282C7D;" onclick="acceptPolicy();" name="I Agree" title="I Agree">Accept</button>
        </span>
        <span>
            <button class="btn btnPrimary ml-1 mr-4" style="color:#282C7D;border:1px solid #282C7D;" onclick="declinePolicy();" name="disagree" title="I Reject">Reject</button>
        </span>
    </div>
</div>
<?php } ?>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="pmr-submenu">
                            ...
                            <li><a href="<?php echo ROOT_URL; ?>research-methodology.asp" title="Research Methodology">Research Methodology</a></li>
                        </ul>
                    </li>
