...
<link rel="preload" as="font" type="font/woff2" crossorigin href="<?php echo ROOT_URL; ?>themes/fonts/open-sans-v43-latin-regular.woff2">
<link rel="preload" as="font" type="font/woff2" crossorigin href="<?php echo ROOT_URL; ?>themes/fonts/open-sans-v43-latin-600.woff2">
<link rel="preload" as="font" type="font/woff2" crossorigin href="<?php echo ROOT_URL; ?>themes/fonts/open-sans-v43-latin-800.woff2">
...
<?php } else{ if(in_array("index",$meta)){  ?>
...
<meta property="og:image" content="<?php echo WEBSITE_URL; ?>themes/image/pmr-logo.png">
...
<meta name="twitter:image" content="<?php echo WEBSITE_URL."themes/image/pmr-logo.png"; ?>">
<?php } ?>
...
<?php }else if(isset($meta) && in_array("search",$meta)){ ?>
<link rel="canonical" href="<?php echo isset($actual_canonical_url) && $actual_canonical_url!='' ? htmlspecialchars($actual_canonical_url, ENT_QUOTES, 'UTF-8') : '' ; ?>">
<?php } ?>
