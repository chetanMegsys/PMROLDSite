<?php 
    if (strpos($_SERVER['REQUEST_URI'], "market-research") !== false){
                    ...
                    <ul class="list-unstyled mb-1" style="line-height: 12px;">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="align-items-center">
                                ...
                                <p class="mb-0 ms-2 font12" style="font-weight:400;">Sustainability</p>
                            </div>
...
<div class="cookiesInfo mb-3">
        <a href="<?php echo ROOT_URL; ?>privacy-policy.asp">We use cookies</a> to improve user experience.
</div>
