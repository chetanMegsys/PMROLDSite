            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo WEBSITE_URL; ?>" title="<?php echo WEBSITE_URL; ?>">
                        <img class="img-responsive" src="<?php echo WEBSITE_URL; ?>assets/images/pmr-logo.png" width="104" height="63" alt="Persistence Market Research" title="Persistence Market Research" />
                    </a>
                </div>
