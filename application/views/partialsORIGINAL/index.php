                    ...
                    <div class="row">
                        <div class="col-xs-6 logoImg">
                            <a href="<?php echo WEBSITE_URL; ?>" title="<?php echo WEBSITE_URL; ?>">
                                <img class="img-responsive" src="<?php echo WEBSITE_URL; ?>assets/images/pmr-logo-white.png" alt="<?php echo WEBSITE_URL; ?>" title="<?php echo WEBSITE_URL; ?>" />
                            </a>
                        </div>
                                ...
                                <div class="row">
                                            ...
                                            <select name="countryCode" id="" class="country-code countryCode" required>
                                                ...
                                                <optgroup label="Other countries">
                                                    <?php if(!empty($countries)){ foreach($countries as $country){ ?>
                                                        <option value="<?php echo $country['code']; ?>"><?php echo $country['name']; ?> (+<?php echo $country['code']; ?>)</option>
                                                    <?php }} ?>
                                                </optgroup>
                                            </select>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-field">
                                            ...
                                            <input type="text" name="captcha" class="captcha-input form-control txtCaptcha" id="captcha-form" maxlength="3" size="3" tabindex=3 required />
                                            <label for="captcha-form" class="form-label">*Security Code</label>
                                            <input type="hidden" class="hdnCaptcha" value="">
                                            <span id="captachacode" class="errormsgs captchaError"></span>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
