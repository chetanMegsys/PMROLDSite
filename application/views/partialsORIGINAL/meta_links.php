...
<?php if(in_array("dc-description",$meta)){ ?> 
...
<?php } if(in_array("report_detail",$meta)){ ?> 
...
<?php }else if(!in_array("sample",$meta)){ ?>
	<link rel="canonical" href="<?php echo $actual_canonical_url; ?>">
<?php } ?>
